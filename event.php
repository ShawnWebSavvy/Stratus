...
try {
	...
	if ($system['s3_enabled']) {
		$event['event_cover'] = ($event['event_cover']) ? $system['system_uploads_url'] . '/' . $event['event_cover'] : $event['event_cover'];
		$event['event_cover_full'] = ($event['event_cover_full']) ? $system['system_uploads_url'] . '/' . $event['event_cover_full'] : $event['event_cover_full'];
	} else {
