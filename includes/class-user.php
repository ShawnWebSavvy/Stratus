            ...
            case 'video':
                ...
                if ($args['video_thumbnail'] == "") {
                    ...
                    if (sizeof($result_) > 0) :
                        ...
                        $db->query(sprintf("UPDATE posts_videos SET thumbnail = 'uploads/thumbnails/" . $result_['thumb'] . "' WHERE video_id = %s", secure($post['video']['video_id']))) or _error("SQL_ERROR_THROWEN");
