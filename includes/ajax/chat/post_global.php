...
try {
	...
	$conversation = $userGlobal->post_conversation_message($_POST['message'], $_POST['photo'], $_POST['voice_note'], $_POST['conversation_id'], $_POST['recipients']);
	/* remove typing status */
	$userGlobal->update_conversation_typing_status($conversation['conversation_id'], false);
