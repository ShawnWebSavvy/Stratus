...
try {
	...
	switch ($_POST['do']) {
		case 'delete_album':
			...
			// delete album
			$path = $userGlobal->global_delete_album($_POST['id']);
		...
		case 'edit_album':
			...
			// edit album
			try {
				$userGlobal->global_edit_album($_POST['id'], $_POST['title']);
		...
		case 'add_photos':
			...
			// add album photos
			$post_id = $userGlobal->global_add_album_photos($inputs);
		...
		case 'delete_photo':
			...
			// delete photo
			$userGlobal->global_delete_photo($_POST['id']);
			break;
