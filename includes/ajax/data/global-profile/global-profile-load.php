...
try {
	...
	if ($_POST['get'] == "newsfeed" || $_POST['get'] == "popular" || $_POST['get'] == "discover" || $_POST['get'] == "saved" || $_POST['get'] == "memories" || $_POST['get'] == "boosted") {
		$data = $userGlobal->global_profile_get_posts(array('get' => $_POST['get'], 'filter' => $_POST['filter'], 'offset' => $_POST['offset']));
		...
		$data = $userGlobal->global_profile_get_posts(array('get' => $_POST['get'], 'filter' => $_POST['filter'], 'offset' => $_POST['offset'], 'id' => $_POST['id']));
		...
		//$data = $userGlobal->get_new_people($_POST['offset'], $random = true, $page = "GlobalHub");
		$data = $user->get_new_people($_POST['offset'], true, "GlobalHub");
		...
		$data = $userGlobal->get_followers($_POST['uid'], $_POST['offset']);
		...
		$data = $userGlobal->get_followings($_POST['uid'], $_POST['offset']);
		...
		$data = $userGlobal->get_conversations($_POST['offset']);
		...
		$append = false;
		$data = $userGlobal->get_conversation_messages($_POST['id'], $_POST['offset']);
	} elseif ($_POST['get'] == "globalMessages") {
		/* check id */
		if (!isset($_POST['id']) || !is_numeric($_POST['id'])) {
			_error(400);
		}
