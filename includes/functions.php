...
{
    global $system;
    $image_source = $system['system_url'] . '/content/themes/' . $system['theme'] . '/images/user_defoult_img.jpg';
    $content = '{
        "requests":[
            {
                "image":{
...
function page_header($title, $description = '', $image = '')
{
    ...
    if ($image == '') {
        if ($system['system_ogimage']) {
            ...
            $image = $system['system_url'] . '/content/themes/' . $system['theme'] . '/images/og-thumbnail.jpg';
        }
    }
...
function get_picture($picture, $type)
{
    ...
    if ($picture == "") {
        switch ($type) {
            ...
            case 'page':
                $picture = $system['system_url'] . '/content/themes/' . $system['theme'] . '/images/svg/svgImg/nav_icon_adHub_active.svg';
                break;

            case 'group':
                $picture = $system['system_url'] . '/content/themes/' . $system['theme'] . '/images/svg/svgImg/newgroupIcon1.svg';
                break;

            case 'event':
                $picture = $system['system_url'] . '/content/themes/' . $system['theme'] . '/images/svg/svgImg/event_add_icon.svg';
                break;

            case 'article':
                $picture = $system['system_url'] . '/content/themes/' . $system['theme'] . '/images//svg/svgImg/blog-defoult-img.jpg';
                break;
            ...
            case 'game':
                $picture = $system['system_url'] . '/content/themes/' . $system['theme'] . '/images/svg/svgImg/games.svg';
                break;
...
function valid_name_no_numbers($name)
{
