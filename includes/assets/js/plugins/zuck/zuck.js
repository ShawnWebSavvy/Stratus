      ...
      var zuckModal = function zuckModal() {
        ...
        var createStoryViewer = function createStoryViewer(
          ...
          var html =
            ...
            currentItemTime +
            '</span></div></div><div class="right"><span class="loading"></span><a class="close" tabIndex="2">&times;</a></div></div><div class="slides-pointers"><div>' +
            pointerItems +
            "</div></div>";
          storyViewer.innerHTML = html;
          //console.log("storyViewer===html", html);
      ...
      zuck.add = zuck.update = function (data, append) {
        ...
        html = 
          ...
          (option("avatars") || !preview || preview == ""
            ? get(data, "photo")
            : preview) +
          ')"></div><span class="img img-zuck"><u style="background-image:url(' +
          (option("avatars") || !preview || preview == ""
            //? get(items[0], 'src')
            ? srcBackground
            : preview) +
