...
/* data */
api["data/live"] = ajax_path + "data/global-profile/global-profile-live.php";
api["data/upload"] = ajax_path + "data/global-profile/global-profile-upload.php";
api["data/reset"] = ajax_path + "data/reset.php";
api["data/report"] = ajax_path + "data/report.php";
/* users */

api["users/image_delete"] = ajax_path + "users/global-profile/image_delete.php";
api["users/image_crop"] = ajax_path + "users/global-profile/image_crop.php";
api["users/image_position"] = ajax_path + "users/global-profile/image_position.php";
api["users/connect"] = ajax_path + "users/global-connect.php";
...
api["users/popover"] = ajax_path + "users/global-popover.php";
api["users/mention"] = ajax_path + "users/mention.php";
api["users/settings"] = ajax_path + "users/settings.php";
api["users/autocomplete"] = ajax_path + "users/global-profile/autocomplete.php";
/* pages_groups_events */
...
api["developers/app"] = ajax_path + "developers/app.php"; // initialize the modal plugins
...
function initialize_modal() {
  ...
  $(".js_scroller").each(function () {
    ...
    if (_this.parent().hasClass("custom-scrollbar")) { } //return;
  ...
  $.post(api["data/live"], data, function (response) {
    if (response.callback) {
      ...
      if (response.conversations) {
        ...
        if (window.location.pathname.indexOf("globalMessages") != -1) {
...
$(function () {
  ...
  notification_highlighter(); // run data heartbeat

  data_heartbeat(); // run autocomplete
        ...
        if (type == "photos") {
          ...
          if (handle == "cover-user" || handle == "cover-page" || handle == "cover-group" || handle == "cover-event") {
            ...
            for (var i in response.files) {
              ...
              attachments.find("ul").append(render_template("#publisher-attachments-image-item", {
            ...
            var image_path = uploads_path + "/" + response.file;
            attachments.find("ul").append(render_template("#comment-attachments-item", {
              src: response.file,
              image_path: image_path
            }));
          } else if (handle == "chat") {
            ...
            var image_path = uploads_path + "/" + response.file;
            attachments.find("ul").append(render_template("#chat-attachments-item", {
              src: response.file,
              image_path: image_path
            }));
          } else if (handle == "x-image") {
          ...
          if (handle == "publisher") {
            ...
            for (var i in response.files) {
              ...
              attachments.find("ul").append(render_template("#publisher-attachments-video-item", {
...
$("body").on("click", ".js_friend-add, .js_friend-cancel, .js_friend-remove", function () {
  ...
  if (_this.hasClass("js_unfollow")) {
    var _do = "follow";
  } else if (_this.hasClass("js_follow")) {
    var _do = "unfollow";
  } else {
    var _do = "unfollow";
  }
  ...
  $.post(api["users/connect"], {
    ...
    if (response.callback) {
      ...
      if (_do == "follow") {
        _this.after('<button type="button" class="btn  btn-warning js_unfollow" data-uid="' + id + '"><i class="fa fa-rss mr5"></i>' + __["Unfollow"] + "</button>");
      } else {
        _this.after('<button type"button" class="btn  btn-success js_follow" data-uid="' + id + '"><i class="fa fa-check mr5"></i>' + __["Follow"] + "</button>");
      }
...
$("body").on("click", ".js_follow, .js_unfollow", function () {
  ...
  $.post(api["users/connect"], {
    ...
    if (response.callback) {
      ...
      if (_do == "follow") {
        _this.replaceWith('<button type="button" title="Follow"  class="btn  btn-info js_unfollow" data-uid="' + id + '"><i class="fa fa-check mr5"></i>' + __["Following"] + "</button>");
      } else {
        _this.replaceWith('<button type="button" title="Unfollow"  class="btn  btn-info js_follow" data-uid="' + id + '"><i class="fa fa-rss mr5"></i>' + __["Follow"] + "</button>");
      }
    }
  }, "json").fail(function () {
    /* button reset */
    ...
    $.post(api["users/connect"], {
      ...
      if (response.callback) {
        ...
        if (_do == "friend-accept") {
          parent.append('<button type="button" class="btn  btn-success btn-delete js_friend-remove" data-uid="' + id + '"><i class="fa fa-check mr5"></i>' + __["Friends"] + "</button>");
        }
      }
    }, "json").fail(function () {
      parent.find(".loader").remove();
  ...
  $("body").on("click", ".js_friend-add, .js_friend-cancel, .js_friend-remove", function () {
    ...
    var _do = ""; // if (_this.hasClass("js_friend-add")) {
    //   var _do = "friend-add";
    ...
    $.post(api["users/connect"], {
      ...
      if (originVar == "localhost") {
        locationPage = window.location.origin + "/sngine";
      } else {
        locationPage = window.location.origin;
      }
      if (response.callback) {
        /* button reset */
        button_status(_this, "reset");
        ...
        if (_do == "friend-add") {
          _this.after(
            '<button type="button" class="btn  btn-warning js_friend-cancel" data-uid="' +
              id +
              '"><img class="btn_image_" src="'+locationPage+'/content/themes/default/images/svg/svgImg/tick.svg">' +
          ...
          _this.after(
            '<button type"button" class="btn btn-success js_friend-add" data-uid="'+id +'"><img class="btn_image_" src="'+locationPage+'/content/themes/default/images/svg/svgImg/add_friend_icon.svg"><img class="btn_image_hover" src="'+locationPage+'/content/themes/default/images/svg/svgImg/add_friend-hover.svg">' +__["Add Friend"] +
                  "</button>"
          );
        }
        _this.remove();*/
  ...
  $("body").on("click", ".js_like-page, .js_unlike-page", function () {
    ...
    $.post(api["users/connect"], {
      ...
      if (response.callback) {
        ...
        if (_do == "page-like") {
          _this.replaceWith('<button type="button" class="btn js_unlike-page" data-id="' + id + '"><i class="fa fa-thumbs-up mr5"></i>' + __["Unlike"] + "</button>");
        } else {
          _this.replaceWith('<button type="button" class="btn js_like-page" data-id="' + id + '"><i class="fa fa-thumbs-up mr5"></i>' + __["Like"] + "</button>");
        }
      }
    }, "json").fail(function () {
      /* button reset */
    ...
    $.post(api["users/connect"], {
      ...
      if (response.callback) {
        ...
        if (_this.hasClass("js_join-group")) {
          if (privacy == "public") {
            _this.replaceWith('<button type="button" class="btn btn-success btn-delete js_leave-group" data-id="' + id + '" data-privacy="' + privacy + '"><i class="fa fa-check mr5"></i>' + __["Joined"] + "</button>");
          } else {
          ...
          _this.replaceWith('<button type="button" class="btn btn-success js_join-group" data-id="' + id +
           '" data-privacy="' + privacy + 
           '"><img class="btn_image_" src="' + locationPage + '/content/themes/default/images/svg/svgImg/add_friend_icon.svg">' + '<img class="btn_image_hover" src="' + locationPage + '/content/themes/default/images/svg/svgImg/add_friend-hover.svg">' +
           __["Join"] + "</button>");
        }
      }
    }, "json").fail(function () {
  ...
  $("body").on("click", ".js_go-event, .js_ungo-event", function () {
    ...
    $.post(api["users/connect"], {
      ...
      if (response.callback) {
        ...
        if (_do == "event-go") {
          _this.replaceWith('<button type="button" class="btn js_ungo-event" data-id="' + id + '"><i class="fa fa-check mr5"></i>' + __["Going"] + "</button>");
        } else {
          _this.replaceWith('<button type="button" class="btn js_go-event" data-id="' + id + '"><i class="fa fa-calendar-check mr5"></i>' + __["Going"] + "</button>");
        }
      }
    }, "json").fail(function () {
      /* button reset */
    ...
    $.post(api["users/connect"], {
      ...
      if (response.callback) {
        ...
        if (_do == "event-interest") {
          _this.replaceWith('<button type="button" class="btn js_uninterest-event" data-id="' + id + '"><i class="fa fa-check mr5"></i>' + __["Interested"] + "</button>");
        } else {
          _this.replaceWith('<button type="button" class="btn js_interest-event" data-id="' + id + '"><i class="fa fa-star mr5"></i>' + __["Interested"] + "</button>");
        }
      }
    }, "json").fail(function () {
      /* button reset */
