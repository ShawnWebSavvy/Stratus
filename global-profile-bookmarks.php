	...
	if (!$user->_logged_in) {
		...
		switch ($_GET['view']) {
			case '':
				...
				// get posts (newsfeed)
				$posts = $userGlobal->global_profile_get_bookmarks_posts();
				/* assign variables */
		...
		$smarty->assign('subactive_page', 'globalhub_bookmarks');
	}
} catch (Exception $e) {
...
// page footer
page_footer("global-profile/global-profile-bookmarks");
