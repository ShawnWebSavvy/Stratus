...
<html>
    <head>
        ...
        <title>Stratus &rsaquo; Installer</title>
        <link rel="stylesheet" type="text/css" href="includes/assets/js/stratus/installer/installer.css" />
        <script src="includes/assets/js/stratus/installer/modernizr.custom.js"></script>
    </head>
    ...
    <body>
        <div class="container">
            <div class="fs-form-wrap" id="fs-form-wrap">
                <div class="fs-title">
                    <h1>Stratus Installer (<?php echo SYS_VER ?>)</h1>
                </div>
                    ...
                    <ol class="fs-fields">
                        ...
                        <li>
                            <p class="fs-field-label fs-anim-upper">
                                Welcome to <strong>Stratus</strong> installation process! Just fill in the information below and create your own social website or online community.
                            </p>
                        </li>
        ...
        <script src="includes/assets/js/stratus/installer/classie.js"></script>
        <script src="includes/assets/js/stratus/installer/fullscreenForm.js"></script>
        <script>
            (function() {
