...
<head>
    ...
    <link rel="stylesheet" type='text/css'
        href="{$system['system_url']}/content/themes/default/css/login.css"  {if !$user->_logged_in}defer{/if}>
    <link rel="stylesheet" type='text/css'
    ...
    <link rel="stylesheet" href="{$system['system_url']}/content/themes/default/css/bootstrap.min.css"  {if !$user->_logged_in}defer{/if}>
    <link rel="stylesheet" type='text/css'
