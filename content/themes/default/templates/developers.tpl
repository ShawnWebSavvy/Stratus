            ...
            <p>{__("Explore the developer tools we offer")}</p>
                ...
                <div class="content-tabs custom-tabs clearfix">
                    <ul>
                        ...
                        <li {if $view=="" }class="active" {/if}>
                            <a href="{$system['system_url']}/developers">{__("Documentation")}</a>
                        </li>
                        {/if}
                        {if $system['developers_apps_enabled']}
                        <li {if $view=="apps" || $view=="new" || $view=="edit" }class="active" {/if}>
                            <a href="{$system['system_url']}/developers/apps">{__("My Apps")}</a>
                        </li>
                        {/if}
                        {if $system['developers_share_enabled']}
                        <li {if $view=="share" }class="active" {/if}>
                            <a href="{$system['system_url']}/developers/share">{__("Share Plugin")}</a>
                        </li>
                        {/if}
                    </ul>
                ...
                <div class="card ">
                    ...
                    <div class="card-body page-content pt30" style="font-size: 1.1em;">
                        ...
                        <p>
                            {__("This documentation explain how to register, configure, and develop your app so you
                            can
                            successfully use our APIs")}
                        </p>

                        <h5 class="mt30 mb20">{__("Create App")}</h5>
                        <p>
                            {__("In order for your app to access our APIs, you must register your app using the")}
                            <a href="{$system['system_url']}/developers/apps">{__("App Dashboard")}</a>.
                            {__("Registration
                            creates an App ID that lets us know who you are, helps us distinguish your app from
                            other
                            apps")}.
                        </p>
                        <ol>
                            ...
                            <li class="mb20">
                                {__("Once you created your App you will get your")} <span
                                    class="badge badge-primary">app_id</span> {__("and")} <span
                                    class="badge badge-primary">app_secret</span>
                            </li>
                        </ol>

                        <h5 class="mt30 mb20">{__("Log in With")}</h5>
                        <p>
                            {__("Log in With system is a fast and convenient way for people to create accounts and
                            log
                            into
                            your app. Our Log in With system enables two scenarios, authentication and asking for
                            permissions to access people's data. You can use Login With system simply for
                            authentication
                            or
                        ...
                        <ol>
                            <li class="mb20">
                                {__("Starting the OAuth login process, You need to use a link for your app like
                                this")}:
                                <pre
                                    class="mtb10">&lt;a href="{$system['system_url']}/api/oauth?app_id=YOUR_APP_ID"&gt;Log in With {$system['system_title']}&lt;/a&gt;</pre>
                            ...
                            <li class="mb20">
                                {__("Once the user accpeted your app, the user will be redirected to your App
                                Redirect
                                URL
                                with")} <span class="badge badge-info">auth_key</span> {__("like this")}:
                                <pre class="mtb10">https://mydomain.com/my_redirect_url.php?auth_key=AUTH_KEY</pre>
                                {__("This")} <span class="badge badge-info">auth_key</span> {__("valid only for one
                                time
                                usage, so once you used it you will not be able to use it again and generate new
                                code
                                you
                                will need to redirect the user to the log in with link again")}.
                            </li>
                        </ol>

                        <h5 class="mt30 mb20">{__("Access Token")}</h5>
                        <p>
                            {__("Once you get the user approval of your app Log in With window and returned with
                            the")}
                            <span class="badge badge-info">auth_key</span> {__("which means that now you are ready
                            to
                            retrive data from our APIs and to start this process you will need to authorize your app
                            and
                            get
                            the")} <span class="badge badge-danger">access_token</span> {__("and you can follow our
                            steps to
                            learn how to get it")}.
                        </p>
                        <ol>
                            <li class="mb20">
                                {__("To get an access token, make an HTTP GET request to the following endpoint like
                                this")}:
                                <pre class="mtb10">&lt;?php
...
?&gt;</pre>
                                {__("This")} <span class="badge badge-danger">access_token</span> {__("valid only
                                for
                                only
                                one 1 hour, so once it got invalid you will need to genarte new one by redirect the
                                user
                                to
                                the log in with link again")}.
                            </li>
                        </ol>

                        <h5 class="mt30 mb20">{__("APIs")}</h5>
                        <p>
                            {__("Once you get your")} <span class="badge badge-danger">access_token</span> {__("Now
                            you
                            can
                            retrieve informations from our system via HTTP GET requests which supports the following
                            parameters")}
                        </p>
    ...
    "user_website": ""
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button data-toggle="tooltip" data-placement="top" title='{__("Delete")}'
                                                class="btn btn-sm btn-icon btn-rounded btn-danger js_developers-delete-app"
                        ...
                        {else}
                        <div class="text-center text-muted mtb10 no_results_Wrap __no_data_contet__">
                            <img width="100%"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-8 col-lg-6 col-xl-5 mx-md-auto">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label" for="app_domain">{__("App
                                            Domain")}</label>
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label" for="app_redirect_url">{__("Redirect
                                            URL")}</label>
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label" for="app_description">{__("App
                                            Description")}</label>
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label" for="app_icon">{__("App Icon (1024 x
                                            1024)")}</label>
                                        <div class="x-image">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-8 col-lg-6 col-xl-5 mx-md-auto">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control" name="app_auth_id"
                                            value="{$app['app_auth_id']}">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="app_auth_secret">{__("App
                                            Secret")}</label>
                                        <input disabled type="text" class="form-control" name="app_auth_secret"
                                            value="{$app['app_auth_secret']}">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="app_name">{__("App Name")}</label>
                                        <input type="text" class="form-control" name="app_name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="app_category" id="app_category">
                                            <option>{__("Select Category")}</option>
                                            {foreach $categories as $category}
                                            <option {if $app['app_category_id']==$category['category_id']}selected{/if}
                                                value="{$category['category_id']}">{__($category['category_name'])}
                                            </option>
                                            {/foreach}
                                        </select>
                                        <span class="form-text">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {else}
                                        <div class="x-image"
                                            style="background-image: url('{$system['system_uploads']}/{$app['app_icon']}')">
...
&lt;/script&gt;</pre>
                        <h6>
                            {__("Then place the share button after changing the URL you want to share to your page
                            HTML")}:
                        </h6>
                        ...
                        <button class="btn btn-sm btn-primary" onclick="SocialShare(site_path)">{__("Click
                            Here")}</button>
                    </div>
                </div>
                <!-- share plugin -->
            ...
            <!-- right panel -->
            <div class="right-sidebar js_sticky-sidebar developerRightBar">
