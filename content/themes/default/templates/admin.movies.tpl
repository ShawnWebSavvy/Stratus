<div class="card">
    ...
    {elseif $sub_view == "add_movie"}
        ...
        <form class="js_ajax-forms admin-add-movie-form" data-url="admin/movies.php?do=add_movie">
            <div class="card-body">
    ...
    {elseif $sub_view == "edit_movie"}
        ...
        <form class="js_ajax-forms admin-edit-movie-form" data-url="admin/movies.php?do=edit_movie&id={$data['movie_id']}">
            <div class="card-body">
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        {__("Movie Source")}
    ...
    {elseif $sub_view == "add_genre"}
        ...
        <form class="js_ajax-forms admin-add-genre-form" data-url="admin/movies.php?do=add_genre">
            <div class="card-body">
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        {__("Name")}
    ...
    {elseif $sub_view == "edit_genre"}
        ...
        <form class="js_ajax-forms admin-edit-genre-form" data-url="admin/movies.php?do=edit_genre&id={$data['genre_id']}">
            <div class="card-body">
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        {__("Name")}
