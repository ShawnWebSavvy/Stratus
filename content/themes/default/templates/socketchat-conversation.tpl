<div class="card panel-messages" data-cid="{$conversation['conversation_id']}" data-uid="{$conversation['user_id']}"  data-color="{$conversation['color']}">
  <div class="card-header with-icon pb10 bg-transparent vvv">
    ...
    {if $active_page == "localhub"}
      {if !$conversation['multiple_recipients']} {if
      $system['video_call_enabled']}
      ...
      {/if} {if $system['audio_call_enabled']}
    ...
    {if !$conversation['multiple_recipients']} {$conversation['name_html_new']}
    {else}
    <span title="{$conversation['name_list']}" class="testeeeee">{$conversation['name_new']}</span>
    {/if}
  </div>
  <div class="card-body">
    ...
    <div class="chat-message-add-new">
      ...
      <div class="chat-voice-notes">
        <div class="voice-recording-wrapper" data-handle="chat">
          ...
          <div class="x-hidden js_voice-processing-message">
            {include file='__svg_icons.tpl' icon="upload" class="mr5"
          ...
          <div class="x-hidden js_voice-success-message">
            {include file='__svg_icons.tpl' icon="checkmark" class="mr5"
      ...
      <div class="x-form chat-form">
        ...
        <ul class="x-form-tools clearfix">
          ...
          {/if} {if $system['voice_notes_chat_enabled']}
