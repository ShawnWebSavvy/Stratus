<div class="card">
    <div class="card-header with-icon">
        {if $sub_view == ""}
            <div class="float-right">
                <a href="{$system['system_url']}/{$control_panel['url']}/games/add" class="btn btn-sm btn-primary btn-antier-skyblue btn-antier-no-border-skyblue">
                    <i class="fa fa-plus mr5"></i>{__("Add New game")}
                </a>
            </div>
        {elseif $sub_view == "add" || $sub_view == "edit"}
            <div class="float-right">
                <a href="{$system['system_url']}/{$control_panel['url']}/games" class="btn btn-sm btn-light btn-antier-skyblue btn-antier-no-border-skyblue">
    ...
    {if $sub_view == ""}
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover js_dataTable admin-game-table">
                    <thead>
                        <tr>
                            <th>{__("ID")}</th>
                            <th>{__("Game")}</th>
    ...
    {elseif $sub_view == "edit"}
        ...
        <form class="js_ajax-forms game-edit-form" data-url="admin/games.php?do=edit&id={$data['game_id']}">
            <div class="card-body">
    ...
    {elseif $sub_view == "add"}
        ...
        <form class="js_ajax-forms game-add-form" data-url="admin/games.php?do=add">
            <div class="card-body">
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        {__("Name")}
