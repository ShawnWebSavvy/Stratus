                            ...
                            <div class="row">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent">
                                             <img class="BlueIcon" alt="image" title="Feelings/Activity" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/fbIcons_black.svg">
                                            </span>
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent">
                                                <img class="BlueIcon" alt="image" title="Feelings/Activity" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/twittericon_black.svg">
                                            </span>
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent">
                                                <img class="BlueIcon" alt="image" title="Feelings/Activity" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/add_video_icon-black.svg">    
                                            </span>
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent">
                                                <img class="BlueIcon" alt="image" title="Feelings/Activity" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/instaIcon-black.svg">    
                                            </span>
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent">
                                                <img class="BlueIcon" alt="image" title="Feelings/Activity" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/inIcon-icon.svg">    
                                            </span>
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent">
                                                <img class="BlueIcon" alt="image" title="Feelings/Activity" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/vkIcon_black.svg">    
                                            </span>
                                        </div>
                    ...
                    <form class="js_ajax-forms " data-url="admin/users.php?id={$data['user_id']}&do=edit_privacy">
                        <div class="form-table-row">
                            <div>
                                ...
                                <div class="form-text d-none d-sm-block">{__("If chat disabled you will appear offline and will not see who is online too")}</div>
                            </div>
