    ...
    <div class="comment {if $_is_reply}reply{/if}" data-id="{$_comment['comment_id']}" id="comment_{$_comment['comment_id']}">
        ...
        <div class="comment-data">
            ...
            <ul class="comment-actions clearfix">
                <!-- reactions -->
                <li>
                    <div class="pointer unselectable sss reactions-wrapper {if $_comment['i_react']}js_unreact-comment{/if}" data-reaction="{$_comment['i_reaction']}">
                        <!-- reaction-btn -->
                    ...
                    {if $user->_logged_in}
                        <div class="x-hidden js_reply-form">
                            <div class="x-form comment-form commentFormChanges">
                                <textarea maxlength="260" dir="auto" class="js_autosize js_mention js_post-reply" rows="1" placeholder='{__("Write a Reply")}'></textarea>
