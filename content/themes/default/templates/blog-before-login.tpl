{if $view == ""}
    ...
    <div class="page-header blog-header-tpl ads-background">
        <img class="floating-img d-none d-md-block" src="{$system['system_url']}/content/themes/{$system['theme']}/images/ads-banner.png">
    ...
    <div class="row {if $user->_logged_in} right-side-content-ant {/if}">
                    ...
                    {else}
                        <!-- no articles -->
                         <div class="text-center no_dataimg_ ">
                            <img width="100%" src="{$system['system_url']}/content/themes/{$system['theme']}/images/no_results4.png">
        ...
        {elseif $view == "category"}
            <div class="row">
                  <!-- side panel -->
                    {if $user->_logged_in}
                    <div class="col-12 offcanvas-sidebar">
                            ...
                            <div class="article-wrapper {if $user->_logged_in}pb10{/if}">
                                        ...
                                        {if $article['manage_post']}
                                            <a class="article-meta-counter unselectable" href="{$system['system_url']}/blogs/edit/{$article['post_id']}">
                                                <div class="cmn_icn_styles">
                                                    <img class="blackicon" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/edit_icon.svg">
                                                    <img class="whiteicon" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/edit_icon_hover.svg" >
                                                   </div>
                                                <span> {__("Edit")} </span>
                                            </a>
                                            <a class="article-meta-counter unselectable js_delete-article" href="#" data-id="{$article['post_id']}">
                                                <div class="cmn_icn_styles">
                                                    <img class="blackicon" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/delete_icon.svg">
                                                    <img class="whiteicon" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/delete_icon_hover.svg" >
                                                   </div>
                                            </a>
                                        {/if}
                                        <a class="article-meta-counter unselectable" href="#article-comments">
                                            <div class="cmn_icn_styles">
                                                <img class="blackicon" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/nav_icon_messages.svg">
                                                <img class="whiteicon" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/nav_icon_nav_icon_messages_hover.svg" >
                                               </div> 
                                               <span> {$article['comments']}</span>
                                        </a>
                                        <div class="article-meta-counter unselectable">
                                            <div class="cmn_icn_styles">
                                                <img class="blackicon" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/eye-icon.svg">
                                                <img class="whiteicon" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/eye-icon_hover.svg" >
                                               </div> 
                               ...
                               <!-- <div class="mb20">
                                ...
                                <a href="http://www.facebook.com/sharer.php?u={$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}"
                                    ...
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/fbIcons.svg" width="20px" height="20px">
                                </a>                                
                                <a href="https://twitter.com/intent/tweet?url={$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}"
                                    ...
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/twittericon.svg" width="20px" height="20px">
                                </a>
                                <a href="https://vk.com/share.php?url={$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}"
                                    class="btn btn-sm btn-rounded btn-social-icon " target="_blank">
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/vkIcon.svg" width="20px" height="20px">
                                </a>
                                <a href="https://www.linkedin.com/shareArticle?mini=true&url={$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}"
                                    class="btn btn-sm btn-rounded btn-social-icon " target="_blank">
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/inIcon.svg" width="20px" height="20px">
                                </a>
                                <a href="https://api.whatsapp.com/send?text={$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}"
                                    class="btn btn-sm btn-rounded btn-social-icon " target="_blank">
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/watsapIcon.svg" width="20px" height="20px">
                                </a>
                                <a href="https://reddit.com/submit?url={$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}"
                                    class="btn btn-sm btn-rounded btn-social-icon  " target="_blank">
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/catIcon.svg" width="20px" height="20px">
                                </a>
                                <a href="https://pinterest.com/pin/create/button/?url={$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}"
                                    class="btn btn-sm btn-rounded btn-social-icon " target="_blank">
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/pintIcon.svg" width="20px" height="20px">
                                </a>
                            </div>
