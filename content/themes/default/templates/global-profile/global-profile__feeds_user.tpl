...
<div class="col-md-6 col-lg-4 mb20">
    <div class="ui-box">
        ...
        <div class="mt10">
            ...
            <!-- <button type="button" class="btn  btn-primary js_friend-accept" data-uid="{$_user['user_id']}">{__("Confirm")}</button>
                    <button type="button" class="btn  btn-danger js_friend-decline" data-uid="{$_user['user_id']}">{__("Delete")}</button>
            ...
            <button type="button" class="btn  btn-warning js_friend-cancel" data-uid="{$_user['user_id']}">
                <img class="btn_image_"
                    src="{$system['system_url']}/content/themes/default/images/svg/svgImg/tick.svg">{__("Friend Request
                Sent")}
            </button>
...
{elseif $_tpl == "list"}
{if !empty($_user['user_firstname']) }

<li class="feeds-item customFollow" {if $_user['id']}data-id="{$_user['id']}" {/if}>
    <div class="data-container {if $_small}small{/if}">
        <a class="data-avatar {$_user['user_id']}"
            href="{$system['system_url']}/global-profile.php?username={$_user['user_name']}">
        ...
        <div class="data-content">
            <div class="float-right">
                ...
                <button type="button" class="btn  btn-warning js_friend-cancel" data-uid="{$_user['user_id']}">
                    <img class="btn_image_"
                        src="{$system['system_url']}/content/themes/default/images/svg/svgImg/tick.svg">{__("Friend
                    Request Sent")}
                </button>
                ...
                {elseif $_connection == "follow"}
                <button type="button" title="Follow" class="btn  btn-info js_follow" data-uid="{$_user['user_id']}">
                    <i class="fa fa-rss mr5"></i>{__("Follow")}
                </button>
            ...
            <div>
                ...
                <a href="{$system['system_url']}/global-profile.php?username={$_user['user_name']}">
                    <span class="search_username"
                        style="color:#a7b4cb;font-size:12px;">@{$_user['user_name']}</span></a>
            </div>
            {if $_connection != "me" && $_user['mutual_friends_count'] > 0 && $active_page !="GlobalHub"}
            <div>
