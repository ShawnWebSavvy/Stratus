...
<div class="container mt20 offcanvas">
    ...
    <div class="row right-side-content-ant">
        ...
        <div class="col-lg-12 offcanvas-mainbar">
            <div class="row">
                <div class="explore_cmn_style col-lg-9 col-md-8">
                <!-- tabs -->
                    <div class="content-tabs custom-tabs clearfix">
                        <ul>
                            ...
                            {foreach $trending_hashtags as $tags}
                                {if $tags@iteration < 4}
                                    <li {if $view=="{$tags['hashtag']}" }class="active" {/if}>
                                        <a href="{$system['system_url']}/global/explore/hashtag/{$tags['hashtag']}">#{$tags['hashtag']}</a>
                                    </li>
                                {/if}
                            {/foreach}
                        </ul>
                    ...
                    <div>
                        <div class="tab-pane active" id="posts">
                            ...
                            <div class="bricklayer">
                                {foreach $trendingPosts as $post} {include file='global-profile/global-profile__feeds_post.tpl'} {/foreach}
                            </div>
                            {else}
                            <div class="bricklayer">
                                <!-- no posts -->
                            ...
                            {/if}
                            {if $people}
                                <div class="globalExploreSection">
                            ...
                            <div class="__no_data_contet__ text-center">
                                <p class="text-center text-muted">
                                    <img src="{$system['system_url']}/content/themes/default/images/no_results16.jpg" width="100%" alt="No friends">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{$system['system_url']}/global-people/search" method="post">
                                ...
                                <button type="submit" class="btn friendsSearchbtn cmn_btn " name="submit">
