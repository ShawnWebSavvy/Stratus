        ...
        {if $_post['post_type'] != "product"}
            ...
            {else}
                {if $_post['colored_pattern']}
                    <div class="post-colored customColorPost 5" {if $_post['colored_pattern']['type'] == "color"}
                    ...
                    {elseif $_post['photos_num'] == 2}
                        {foreach $_post['photos'] as $photo}
                            <div class="pg_2x {if $photo['blur']}x-blured{/if}">
                                <a href="{$system['system_url']}/global-profile-photo/{$photo['photo_id']}" class="js_lightbox_antier"
