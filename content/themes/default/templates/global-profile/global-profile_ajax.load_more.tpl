{if $get == 'newsfeed' || $get == 'posts_profile' || $get == 'posts_page' || $get == 'posts_group' || $get ==
'posts_group_pending' || $get == 'posts_group_pending_all' || $get == 'posts_event' || $get == 'posts_event_pending' ||
$get == 'posts_event_pending_all' || $get == 'saved' || $get == 'memories' || $get == 'boosted' || $get == 'popular' ||
$get == 'discover' }
...
{include file='global-profile/global-profile__feeds_post.tpl' _tpl="featured"}
{/foreach}
...
{elseif $get == 'shares'}
{foreach $data as $post}
{include file='global-profile__feeds_post.tpl' _snippet=true}
{/foreach}


{elseif $get == 'post_comments' || $get == 'post_comments_top' || $get == 'photo_comments' || $get ==
'photo_comments_top'}
{foreach $data as $comment}
{include file='global-profile/__feeds_comment.tpl' _comment=$comment}
{/foreach}

{elseif $get == 'comment_replies'}
{foreach $data as $comment}
{include file='global-profile/__feeds_comment.tpl' _comment=$comment _is_reply=true}
{/foreach}


{elseif $get == 'photos'}
{foreach $data as $photo}
{include file='global-profile/global-profile__feeds_photo.tpl' _context=$context}
{/foreach}
...
{elseif $get == 'post_reactions' || $get == 'photo_reactions' || $get == 'comment_reactions' || $get == 'voters' || $get
== 'blocks' || $get == 'affiliates' || $get == 'group_requests'}
...
{foreach $data as $_user}
{include file='global-profile/__feeds_user.tpl' _tpl="list" _connection="follow"}
{/foreach}


{elseif $get == 'friends' || $get == 'followers' || $get == 'followings' || $get == 'page_invites' || $get ==
'group_members' || $get == 'group_invites' || $get == 'event_going' || $get == 'event_interested' || $get ==
'event_invited' || $get == 'event_invites'}
{foreach $data as $_user}
...
{elseif $get == 'events' || $get == 'suggested_events' || $get == 'going_events' || $get == 'interested_events' || $get
== 'invited_events' || $get == 'profile_events'}
