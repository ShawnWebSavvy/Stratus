        ...
        <div class="post-meta">
            ...
            <div class="post-time">
                ...
                {elseif $post['privacy'] == "friends"}
                    ...
                    <span class="share_sign_img" data-toggle="tooltip" data-placement="top" title='{__("Shared with")} {__("Friends")}'> <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/friendsIcon.svg" class="blackicon"> </span>
                {elseif $post['privacy'] == "public"}
                    <!-- <i class="fa fa-globe" data-toggle="tooltip" data-placement="top" title='{__("Shared with")} {__("Public")}'></i> -->
                    <span class="share_sign_img" data-toggle="tooltip" data-placement="top" title='{__("Shared with")}: {__("Public")}'> <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/nav_icon_globalHub.svg" class="blackicon"> </span>
        ...
        <div class="mt10 clearfix">
            <div class="pg_wrapper">
                <div class="pg_1x {if $photo['blur']}x-blured{/if}">
                    <a href="{$system['system_url']}/global-profile-photo/{$photo['photo_id']}" class="js_lightboxs global-profile-photo" data-id="{$photo['photo_id']}" data-image="{$system['system_uploads']}/{$photo['source']}" data-context="{if $photo['is_single']}album{else}post{/if}">
