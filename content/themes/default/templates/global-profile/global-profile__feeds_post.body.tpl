...
<div class="post-header">
   ...
   <div class="post-colored customColorPost 6" {if $_post['colored_pattern']['type']=="color" }
   ...
   <div>
      <video class="js_fluidplayer"
         ...
         _logged_in}onplay="update_media_views('video', {$_post['video']['video_id']})"{/if} {if
   ...
   <div class="plr10">
      <audio class="js_audio" id="audio-{$_post['audio']['audio_id']}" {if $user->
         _logged_in}onplay="update_media_views('audio', {$_post['audio']['audio_id']})"{/if} controls preload="auto"
         style="width: 100%;">
