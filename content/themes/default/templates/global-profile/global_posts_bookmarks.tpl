	        ...
	        <div class="btn-group btn-group-sm js_posts-filter" data-value="all">
	            ...
	            <div class="dropdown-menu dropdown-menu-right fillterPopChange ">
					...
					<div class="dropdown-item pointer" data-title='{__("Audios")}' data-value="audio">
						<div class="imgHover">
							<img alt="Audios" title="Audios" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/add_voice_notesHover.svg">
							<img alt="Audios" class="hoverIcon" title="Audios" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/add_voice_notes.svg">
						</div>
						{__("Audio")}
					</div>
					{/if} 
		...
		<div class="" data-get="{$_get}" data-filter="{if $_filter}{$_filter}{else}all{/if}" {if $_id}data-id="{$_id}"{/if}>
			<ul class="global-profile-ul-post noDataWrapImage">
				...
				<div class="text-center text-muted no_data_img_ __no_data_contet__">
					<img width="100%" src="{$system['system_url']}/content/themes/{$system['theme']}/images/no_results5.png">
