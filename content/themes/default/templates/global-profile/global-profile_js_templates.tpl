...
<script id="modal-confirm" type="text/template">
  ...
  <div class="modal-footer">
      ...
      <button type="button" class="btn btn-success btn-antier-green" id="modal-confirm-ok">{__("Confirm")}</button>
  </div>
</script>
...
<script id="translator" type="text/template">
  ...
  <div class="modal-body language_footer_div">
...
<!-- commentModal -->
<script id="commentModalbox" type="text/template">
...
<script id="forget-password-confirm" type="text/template">
  ...
  <form class="js_ajax-forms forget-password-confirm-form" data-url="core/forget_password_confirm.php">
      <div class="modal-body">
          <div class="mb20">
      ...
      <div class="modal-footer">
          ...
          <button type="button" class="btn btn-light" data-dismiss="modal">{__("Cancel")}</button>
          <button type="submit" class="btn btn-success btn-antier-green">{__("Continue")}</button>
      </div>
  </form>
</script>
...
<script id="forget-password-reset" type="text/template">
  ...
  <form class="js_ajax-forms forget-password-reset-form" data-url="core/forget_password_reset.php">
      <div class="modal-body">
          <div class="form-group">
...
<script id="two-factor-authentication" type="text/template">
  ...
  <form class="js_ajax-forms two-factor-authentication-form" data-url="core/two_factor_authentication.php">
      <div class="modal-body">
          <div class="mb20">
...
<script id="activation-email-reset" type="text/template">
  ...
  <form class="js_ajax-forms activation-email-reset-forms" data-url="core/activation_email_reset.php">
      <div class="modal-body">
          <div class="form-group">
...
<script id="activation-phone" type="text/template">
  ...
  <form class="js_ajax-forms activation-phone-form" data-url="core/activation_phone_confirm.php">
      <div class="modal-body">
          <div class="mb20">
...
<script id="activation-phone-reset" type="text/template">
  ...
  <form class="js_ajax-forms activation-phone-reset-form" data-url="core/activation_phone_reset.php">
      <div class="modal-body">
          {if $user->_data['user_phone']}
              <div class="form-group">
...
<script id="x-uploader" type="text/template">
  <form class="x-uploader" action="{literal}{{url}}{/literal}" method="post" enctype="multipart/form-data">
      {literal}{{#multiple}}{/literal}
          <input name="file[]" type="file" title="{literal}{{title}}{/literal}" multiple="multiple" accept="{literal}{{accept}}{/literal}">
      {literal}{{/multiple}}{/literal}
      {literal}{{^multiple}}{/literal}
     ...
     {if $page == 'global-profile/global-profile' }
...
<!--<div class="chat-sidebar {if !$user->_data['user_chat_enabled']}disabled{/if}">
            <div class="chat-sidebar-header clickChatWindow">
                ...
                <div class="js_scroller" data-slimScroll-height="100%">
                    <ul>
                        {foreach $sidebar_friends as $_user}
                            <li class="feeds-item">
                                <div class="data-container clickable small js_chat_start" data-uid="{$_user['user_id']}" data-name="{$_user['user_firstname']} {$_user['user_lastname']}" data-link="{$_user['user_name']}">
                                    <div class="data-avatar">
  ...
  <div class="chat-widget chat-box opened fresh">
      ...
      <div class="chat-widget-content">
          ...
          <div class="chat-to clearfix js_autocomplete-tags">
              ...
              <ul class="tags"></ul>
              <div class="typeahead addSrcollUser">
          ...
          <div class="conversation-body chat-message-user-section1">
              <div class="text js_chat-color-me" {literal}{{#color}}{/literal}style="background-color: {literal}{{color}}{/literal}"{literal}{{/color}}{/literal}>
                  <div class="chat-message-user-section">
                      <img src="{literal}{{sendUserImage}}{/literal}">
...
<!-- Gifts -->
{if $system['gifts_enabled'] && $page == "global-profile/global-profile"}
<script id="gifts" type="text/template">
  ...
  <form class="js_ajax-forms gifts_enabled gifts_enabled-form" data-url="users/gifts.php?do=send&uid={literal}{{uid}}{/literal}">
      <div class="modal-body">
      ...
      <div class="modal-footer">
          <button type="submit" class="btn btn-success btn-antier-green">{__("Send")}</button>
      </div>
  </form>
</script>
...
{if $page == "index" || $page == "global-profile/global-profile" || $page ==
"page" || $page == "group" || $page == "event" || $page == "post" || $page ==
"photo" || $page == "market" || $page == "blogs" || $page == "directory" ||
$page == "search" || $page == "share" || $page ==
"global-profile/global-profile-timeline" || $page ==
"global-profile/global-profile-post"|| $page ==
"global-profile/global-profile-photo"}
<!-- Publisher -->
...
<script id="edit-post" type="text/template">
  <div class="post-edit">
      <div class="x-form comment-form">
          ...
          <ul class="x-form-tools clearfix emojiChangeGlobal">
      ...
      <div class="edit_btns">
          <span class="text-link cncl_btn js_unedit-post">{__("Cancel")}</span>
          <button type="button" class="btn  js_publisher_updatebtn  btn-publisher btn-share-style"> Share </button>
      </div>
  </div>
</script>
...
<script id="create-page" type="text/template">
  ...
  <form class="js_ajax-forms create-event-form" data-url="pages_groups_events/create.php?type=page&do=create">
      <div class="modal-body">
          <div class="form-group">
      ...
      <div class="modal-footer">
          <button type="button" class="btn btn-light" data-dismiss="modal">{__("Cancel")}</button>
          <button type="submit" class="btn btn-success btn-antier-green">{__("Create")}</button>
      </div>
  </form>
</script>
{/if} {if $page == "groups"}
<script id="create-group" type="text/template">
  ...
  <form class="js_ajax-forms create-event-form create-event-js-template"  data-url="pages_groups_events/create.php?type=group&do=create">
      <div class="modal-body">
          <div class="form-group">
...
<script id="create-event" type="text/template">
  ...
  <form class="js_ajax-forms create-event-form" data-url="pages_groups_events/create.php?type=event&do=create">
      <div class="modal-body">
          <div class="form-group">
...
<script id="wallet-transfer" type="text/template">
  ...
  <form class="js_ajax-forms wallet-transfer-js-template-form" data-url="ads/wallet.php?do=wallet_transfer">
      <div class="modal-body">
          <div class="form-group">
      ...
      <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-success btn-antier-green walletSendButton"><i class="fas fa-check mr20"></i> {__("Send")}</button>
      </div>
  </form>
</script>
...
<script id="wallet-withdraw-affiliates" type="text/template">
  ...
  <form class="js_ajax-forms wallet-withdraw-affiliates-js-template-form" data-url="ads/wallet.php?do=wallet_withdraw_affiliates">
      <div class="modal-body">
          <div class="form-group">
...
{if $page == "started" || $page == "global-profile/global-profile" || $page ==
"page" || $page == "group"}
<script id="crop-profile-picture" type="text/template">
  ...
  <div class="modal-footer">
      <button type="button" class="btn btn-light" data-dismiss="modal">{__("Cancel")}</button>
      <button type="button" class="btn btn-success btn-antier-green js_crop-picture" data-handle="{literal}{{handle}}{/literal}" data-id="{literal}{{id}}{/literal}">{__("Save")}</button>
  </div>
</script>
{/if}
<!-- Crop Profile Picture -->
