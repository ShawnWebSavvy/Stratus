<div class="post-comments global-post-comments">
    ...
    <div class="comments-filter">
        <div class="btn-group btn-group-sm js_comments-filter" data-value="photo_comments">
            ...
            <div class="dropdown-menu dropdown-menu-left">
                <div class="dropdown-item pointer" data-value="photo_comments" data-id="{$photo['photo_id']}">{__("Most
                    Recent")}</div>
                <div class="dropdown-item pointer" data-value="photo_comments_top" data-id="{$photo['photo_id']}">
                    {__("Top Comments")}</div>
            </div>
        </div>
    </div>
    ...
    <!-- post comment -->
    {include file='global-profile/global-profile__feeds_comment.form.tpl' _handle='photo' _id=$photo['photo_id']}
    <!-- post comment -->
    ...
    <div class="pb10 text-center js_see-more" data-get="photo_comments" data-id="{$photo['photo_id']}"
    ...
    <div class="comments-filter">
        <div class="btn-group btn-group-sm js_comments-filter" data-value="post_comments">
            ...
            <div class="dropdown-menu dropdown-menu-left">
                <div class="dropdown-item pointer" data-value="post_comments" data-id="{$post['post_id']}">{__("Most
                    Recent")}</div>
                <div class="dropdown-item pointer" data-value="post_comments_top" data-id="{$post['post_id']}">{__("Top
                    Comments")}</div>
            </div>
        </div>
    </div>
    ...
    <!-- post comment -->
    {include file='global-profile/global-profile__feeds_comment.form.tpl' _handle='post' _id=$post['post_id']}
    <!-- post comment -->
    ...
    <div class="ptb10 text-center js_see-more" data-get="post_comments" data-id="{$post['post_id']}" data-remove="true"
