...
<div class="x-form publisher" data-handle="{$_handle}" {if $_id}data-id="{$_id}" {/if}>
    ...
    <div class="publisher-message">
        {if $_handle == "page"}
        <img class="publisher-avatar" id="global-profile-publisher-avatar" src="{$spage['page_picture']}">
        {else}
        <img class="publisher-avatar" id="global-profile-publisher-avatar" src="{$user->_data['global_user_picture']}">
        {/if}
        <div class="globalTextareaWrapsPost">
            <div class="colored-text-wrapper">
                <textarea dir="auto" maxlength="260" class="js_autosize js_mention js_publisher-scraper"
                    data-init-placeholder='{__("What is your Stratus? @mention #hashtag")}'
                    placeholder='{__("What is your Stratus? @mention #hashtag")}'>{if $page == "share" && $url}{$url}{/if}</textarea>
            </div>
            ...
            <ul>
                ...
                <li class="col-md-6">
                    <div class="publisher-tools-tab attach js_publisher-tab" data-tab="photos">
                        <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/camera.png"
                ...
                <li class="col-md-6">
                    <div class="publisher-tools-tab js_publisher-feelings">
                        <img
                            src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/smile.png">{__("Feelings/Activity")}
                    </div>
                </li>
                <li class="col-md-6">
                    <div class="publisher-tools-tab js_publisher-tab" data-tab="album">
                        <img
                            src="{$system['system_url']}/content/themes/{$system['theme']}/images/svg/svgImg/addPostAlbum.svg">{__("New
                        Album")}
                    </div>
                </li>
            </ul>
            <button type="button"
                class="btn btn-sm btn-success ml5 js_publisher btn-antier-green btn-publisher">{__("Post")}</button>
        </div>
        <div class="publisher-emojis">
            ...
            <div class="position-relative">
                <button type="button"
                    class="btn-add-textarea btn btn-sm btn-success ml5 btn-antier-green btn-publisher">+
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="publisher-slider">
        ...
        <div class="publisher-meta" data-meta="colored">
            ...
            <div class="colored-pattern-item js_publisher-pattern" data-id="{$pattern['pattern_id']}"
                data-type="{$pattern['type']}" data-background-image="{$pattern['background_image']}"
                data-background-color-1="{$pattern['background_color_1']}"
                data-background-color-2="{$pattern['background_color_2']}" data-text-color="{$pattern['text_color']}"
                {if $pattern['type']=="color" }
                style="background-image: linear-gradient(45deg, {$pattern['background_color_1']}, {$pattern['background_color_2']});"
                {else} style="background-image: url({$system['system_uploads']}/{$pattern['background_image']})" {/if}>
            </div>
            {/foreach}
        </div>
        <!-- post colored -->
        ...
        <div class="publisher-tools-tabs">
            <ul class="row publisher-tools-tabs-ul">
                {if $system['photos_enabled']}
                <li class="col-md-6">
                    <div class="publisher-tools-tab attach js_publisher-tab" data-tab="photos">
                        <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/svg/camera.svg"
                            class="js_x-uploader" data-handle="publisher" data-multiple="true">
                        {__("Upload Photos")}sdfdsf
                ...
                {/if}
                <!-- {if $user->_data['can_sell_products'] && $_handle != "page" && $_handle != "group" && $_handle !=
                "event"}
                <li class="col-md-6">
                ...
                {/if} -->
                {if $user->_data['can_write_articles'] && $_handle != "page" && $_handle != "group" && $_handle !=
                "event"}
                <li class="col-md-6">
                ...
                <li class="col-md-6">
                    <div class="publisher-tools-tab attach js_publisher-tab" data-tab="video">
                        <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/svg/video_camera.svg"
                            class="js_x-uploader" data-handle="publisher" data-type="video">
                        {__("Upload Video")}
                    </div>
                </li>
                {/if}
                ...
                <li class="col-md-6">
                    <div class="publisher-tools-tab attach js_publisher-tab" data-tab="audio">
                        <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/svg/music_file.svg"
                ...
                <li class="col-md-6">
                    <div class="publisher-tools-tab attach js_publisher-tab" data-tab="file">
                        <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/svg/folder.svg"
            ...
            <div class="btn-group js_publisher-privacy" data-toggle="tooltip" data-placement="top" data-value="me"
                ...
                <div class="btn-group js_publisher-privacy" data-toggle="tooltip" data-placement="top"
                        ...
                        <button type="button" class="btn btn-sm btn-info dropdown-toggle" data-toggle="dropdown"
                            ...
                            <span class="share_sign_img">
                                <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/nav_icon_globalHub.svg"
                                    class="blackicon">
                            </span><span class="btn-group-text">{__("Public")}</span>
                        </button>
                        {/if}
                    ...
                    <button disabled="disabled" type="button"
                        class="btn btn-sm btn-light x-hidden js_publisher-privacy-public" data-toggle="tooltip"
