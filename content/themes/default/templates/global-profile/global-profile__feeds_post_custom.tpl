...
<ul class="child-post-ul secoundPostHidd">
    <li class="child-post-first-li" data-id="{$post['post_id']}">
        ...
        <div class="post-actions globalPostActions clearfix">
            ...
            <div class="action-btn unselectable reactions-wrapper">
                ...
                <div class="dropdown globalDropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            {else}
                                <a class="dropdown-item tweet-global" data-reaction="retweet" id="tweetPost_{$post['post_id']}" data-id="{$post['post_id']}" href="javascript:void(0);">Repost</a>
                            {/if}
                        <a class="dropdown-item" data-toggle="modal" data-url="posts/global-profile/share.php?do=create&amp;post_id={$post['post_id']}">Quote Post</a>
                    </div>
                </div>
                </div>
                <!-- retweet-btn -->
            ...
            <div class="action-btn unselectable reactions-wrapper {if $post['i_react']}js_unreact-post{/if} js_react-post"
        ...
        <!-- post actions -->
            ...
            <div class="post-approval">
                ...
                <button class="btn btn-danger btn-sm js_delete-post"><i
