...
{if $user->_logged_in}
    ...
    <script src="{$system['system_url']}/includes/assets/js/plugins/jquery-ui.triggeredAutocomplete/jquery-ui.triggeredAutocomplete.js" {if !$user->_logged_in}defer{/if}></script>
    <!-- jQuery-UI -->

    <!-- Sticky Sidebar -->
    <script src="{$system['system_url']}/includes/assets/js/plugins/sticky-sidebar/theia-sticky-sidebar.min.js" {if !$user->_logged_in}defer{/if}></script>
    <!-- Sticky Sidebar -->

    <!-- Google Geocomplete -->
    {if $system['geolocation_enabled']}
        <script src="{$system['system_url']}/includes/assets/js/plugins/jquery.geocomplete/jquery.geocomplete.min.js" {if !$user->_logged_in}defer{/if}></script>
    ...
    {if $system['noty_notifications_enabled']}
        <script src="{$system['system_url']}/includes/assets/js/plugins/noty/noty.min.js" {if !$user->_logged_in}defer{/if}></script>
        <link rel="stylesheet" type='text/css' href="{$system['system_url']}/includes/assets/js/plugins/noty/noty.css" {if !$user->_logged_in}defer{/if}>
    {/if}
    <!-- Noty Notifications -->
...
{if $user->_logged_in}
    ...
    <script src="{$system['system_url']}/includes/assets/js/stratus/showads.js?{$cacheremovejs}"></script>
