   ...
   <div class="row right-side-content-ant profile-mobile-layout flex-wrap profile_psge">
      <div class="home-page-middel-block ">
         <div class="row">
                  ...
                  <div class="d-flex profile_sec w-100 align-items-end">
                     ...
                     <div class="profile_avatar_img">
                        <div class="profile-avatar-wrapper">
                           ...
                           <div class="profile-avatar-delete {if $profile['user_picture_default']  || !$profile['user_picture_id']}x-hidden{/if}">
                     ...
                     <div class="profile-name-wrapper profile_name_sec global_User_Bio">
                        <div>
                           ...
                           <span class="blue_tick verified-badge" data-toggle="tooltip" data-placement="top" title='{__("Verified User")}'>
                           <img class="" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/tick.svg">
                           </span> 
                           {/if}
                        ...
                        <div class="PostFollowerWrap bg-transparent">
                           <div class="PostCount">
                              <span class="ml5">{$posts_count}</span><a href="{$system['system_url']}/global-profile.php?username={$profile['user_name']}">{__("Posts")}</a>
                           </div>
                           <div class="PostCount">
                              <span class="ml5">{$profile['followers_count']}</span><a href="{$system['system_url']}/global-profile.php?username={$profile['user_name']}&view=followers">{__("Followers")}</a>
                           </div>
                           <!-- <div class="PostCount">
            ...
            <a class="user-box" href="{$system['system_url']}/global-profile.php?username={$followeuser['user_name']}">
            <img {$followeuser['user_picture_full']} alt="{$followeuser['user_firstname']} {$followeuser['user_lastname']}"
