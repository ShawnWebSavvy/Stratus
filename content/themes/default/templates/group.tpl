                    ...
                    {if $get == "posts_group"}
                        ...
                        {if $group['i_admin'] && $group['total_requests'] > 0}
                            <div class="alert alert-info">
                                ...
                                $group['total_requests'] == 1}{__("person")}
                                {else}
                                    {__("persons")}
                                {/if} {__("wants to join
                                this
                    ...
                    {if $group['pending_posts'] > 0}
                        <div class="alert alert-info">
                            ...
                            <div class="text align-middle">
                                ...
                                $group['pending_posts'] == 1}{__("post")}
                                {else}
                                    {__("posts")}
                                {/if} {__("pending needs your
                                approval")}
                                {else}
                        ...
                        <div class="card-body">
                            {if $group['photos']}
                                ...
                                <div class="alert alert-info see-more js_see-more" data-get="photos"
                                    data-id="{$group['group_id']}" data-type='group'>
                                        ...
                                        <ul class="side-nav">
                                            <li {if $sub_view=="" }class="active" {/if}>
                                                <a class="d-flex" style="align-items: center;"
                                                    href="{$system['system_url']}/groups/{$group['group_name']}/settings">
                                                    <i style="width: 20px;height: 20px;margin-right: 10px;"
                                                        class="fa fa-cog fa-fw"></i>{__("Group Settings")}</a>
                                            </li>
                                            {if $group['group_privacy'] != "public"}
                                                <li {if $sub_view=="requests" }class="active" {/if}>
                                                    <a class="d-flex" style="align-items: center;"
                                                        ...
                                                        <i style="width: 20px;height: 20px;margin-right: 10px;"
                                                            class="fa fa-user-plus fa-fw"></i>{__("Join Requests")}</a>
                                                </li>
                                            {/if}
                                            <li {if $sub_view=="members" }class="active" {/if}>
                                                <a class="d-flex" style="align-items: center;"
                                                    ...
                                                    <i style="width: 20px;height: 20px;margin-right: 10px;"
                                                        class="fa fa-users fa-fw"></i>{__("Members")}</a>
                                            </li>
                                            {if $user->_data['user_id'] == $group['group_admin']}
                                                <li {if $sub_view=="delete" }class="active" {/if}>
                                                    <a class="d-flex" style="align-items: center;"
                                                        ...
                                                        <i style="width: 20px;height: 20px;font-size: 16px;display: flex;align-items: center;justify-content: center; margin-right: 10px;"
                                                            class="fa fa-trash fa-fw "></i>{__("Delete Group")}</a>
                                                </li>
                                            {/if}
                                        </ul>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class='option'>
                                                        ...
                                                        <div class='text'>
                                                            <b>{__(" Public Group")}</b><br>{__("Anyone can see the group, its members
                                                        and their posts")}.
                                            </div>
                                        </div>">
                                                            {__("Public Group")}
                                                ...
                                                <div class='option'>
                                                    ...
                                                    <div class='text'>
                                                        <b>{__(" Closed Group")}</b><br>{__("Only members can see posts")}.
                                </div>
                            </div>">
                                                            {__("Closed Group")}
                                                        </option>
                                ...
                                Secret Group")}</b><br>{__("Only members can find the group and see posts")}.
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="category" id="category">
                                                        {foreach $categories as $category}
                                                            <option {if $group['group_category']==$category['category_id']}selected{/if}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="description"
                                                        id="description">{$group['group_description']}</textarea>
                                                </div>
                                                <!-- custom fields -->
                ...
                _registration=false} {/if}
                                                ...
                                                <div class="form-table-row">
                                                    <div>
                                                        ...
                                                        <div class="form-text d-none d-sm-block">
                                                            {__("Members can publish posts or only group admins")}</div>
                                                    </div>
                                                    <div class="text-right">
                                                        <label class="switch" for="group_publish_enabled">
                                                            <input type="checkbox" name="group_publish_enabled"
                                                                id="group_publish_enabled" {if
                        ...
                        posts")})
                                                ...
                                                <div class="text-right">
                                                    <label class="switch" for="group_publish_approval_enabled">
                                                        <input type="checkbox" name="group_publish_approval_enabled"
                                                            id="group_publish_approval_enabled" {if
                    ...
                    _connection=$_user["connection"]} {/foreach}
                                        ...
                                        {if count($group['requests']) >= $system['max_results']}
                                            <!-- see-more -->
                                            <div class="alert alert-info see-more js_see-more" data-get="group_requests"
                                                data-id="{$group['group_id']}">
                                                <span>{__("Load More")}</span>
                                                <div class="loader loader_small x-hidden"></div>
                                            </div>
                            ...
                            _connection=$_user["connection"]} {/foreach}
                                                ...
                                                {if $group['group_admins_count'] >= $system['max_results_even']}
                                                    <!-- see-more -->
                                                    <div class="alert alert-info see-more js_see-more" data-get="group_admins"
                                                        data-id="{$group['group_id']}">
                                                        <span>{__("Load More")}</span>
                                                        <div class="loader loader_small x-hidden"></div>
                                                    </div>
