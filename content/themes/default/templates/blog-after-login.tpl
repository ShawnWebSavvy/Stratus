            ...
            <div class="blogs-wrapper blogAftrLogin home-page-middel-block">
                ...
                <div class="add-new-product-section blogaddNewProduct">
                    ...
                    <a href="{$system['system_url']}/articles" class="btn btn-sm cmn_btn btn-block ">
                        <img src="{$system['system_uploads_assets']}/content/themes/{$system['theme']}/images/svg/svgImg/blogNews.svg">
                        {__("My Articles")}
                    </a>
                </div>
                        ...
                        <div class="article-wrapper {if $user->_logged_in}pb10{/if}">
                            ...
                            <div class="post-actions clearfix">
                                ...
                                <div class="_share_post_ dropdown">
                                    <div class="action-btn dropdown-toggle dropdown-toggle-share" id="stratus_post_{$article['post_id']}" parent-data-id="{$post['post_id']}"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-url="posts/share.php?do=create&post_id={$article['post_id']}">
                                    ...
                                    <div class="_share-dropdown_ dropdown-menu-right dropdown-menu fade" aria-labelledby="stratus_post_{$article['post_id']}" data-toggle="modal"
                                        ...
                                        <div class="share_icon_list">
                                            <ul class="-list_items">
                                                <li class="stratus_local_share" id="share_timeline">
                                                    <label for="share_to_timeline">
                                                        <span class="__list_icon">
                                                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/share-timeline.svg">
                                                        </span>
                                                        <span>Share to Timeline</span>
                                                    </label>
                                                </li>
                                                {if $system['groups_enabled'] && is_array($groups)&&count($groups) > 0}
                                                <li class="stratus_local_share" id="share_group">
                                                    <label for="share_to_group">
                                                        <span class="__list_icon">
                                                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/share_grp.svg">
                                                        </span>
                                                ...
                                                <li class="stratus_local_share" id="share_page">
                                                    <label for="share_to_page">
                                                        <span class="__list_icon">
                                                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/share-page.svg">
                                                        </span>
                                                        <span>Share to a Page</span>
                                                    </label>
                                                </li>
                                                {/if}
                                                <li class="stratus_local_share" id="share_post">
                                                    <label for="write_post">
                                                        <span class="__list_icon">
                                                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/write-post.svg">
                                                        </span>
                                                        <span>Write post</span>
                                                    </label>
                                                </li>
                                                {if $system['social_share_enabled']}
                                                <li class="stratus_local_share" id="share_social_media">
                                                    <label for="share_to_sm">
                                                        <span class="__list_icon">
                                                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/share-sm.svg">
                                                        </span>
                        ...
                        <div class="js_ajax-forms-html " data-url="posts/article.php?do=edit&id={$article['post_id']}">
                            <div class="card-body">
                                <div class="form-group form-row">
                                    <label class="col-md-2 form-control-label">{__("Cover")}</label>
                                    <div class="col-md-10">
                                        {if $article['article']['cover'] == ''}
                                        <div class="x-image">
