...
<div class="card main-side-nav-card">
    <div class="card-body with-nav">
        <div class="chat-conversations js_scroller left_sidebar_" data-slimScroll-height="87vh">
            <ul class="main-side-nav main-left-side-nav left-sidebar-{if ($page == 'global-profile/landingpage')}second-ul active {else}first-ul{/if}">
            ...
            <ul class="main-side-nav main-left-side-nav left-sidebar-{if ($active_page=='LocalHub')}second-ul active {else}first-ul{/if}">
                ...
                <li {if $subactive_page=="pages" }class="active" {/if}>
                    <a href="{$system['system_url']}/pages">
                        <div class="svg-container">
                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/explore_iconN.svg" class="">
                        </div>
            ...
            <!-- Global Hub starts -->
            <ul class="main-side-nav main-left-side-nav left-sidebar-{if ($active_page=='GlobalHub')}second-ul active {else}first-ul{/if} {$page}">
                ...
                <li {if ($subactive_page=='globalhub_bookmarks' )}class="active" {/if}>
                    ...
                    <a href="{$system['system_url']}/global-profile-bookmarks.php">
                        <div class="svg-container">
                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/bookmark_iconN.svg" class="">
                        </div>
            ...
            <ul class="main-side-nav main-left-side-nav left-sidebar-{if ($active_page=='BlogHub')}second-ul active {else}first-ul{/if} {$page}">
            ...
            <ul class="main-side-nav main-left-side-nav left-sidebar-first-ul {if ($active_page=='MarketHub')}second-ul active {else}first-ul{/if} {$page}">
            ...
            <ul class="main-side-nav main-left-side-nav left-sidebar-five-ul">
                <li>
                    <a href="{$system['system_url']}/signout">
                        <div class="svg-container">
                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/logOutNew.svg" class="blackicon">
                            <img src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/logOut_activeNew.svg" class="whiteicon">
                        </div>
