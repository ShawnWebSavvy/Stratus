        ...
        <div class="ui-box">
            <div class="img">
                <a href="{$system['system_url']}/games/{$_game['game_id']}/{$_game['title_url']}">
                    <img class="lazyload" alt="{$_game['title']}" data-src="{$_game['thumbnail']}" />
                </a>
            </div>
            <div class="mt10">
            ...
            <div class="mt10">
                <a class="btn btn-primary" href="{$system['system_url']}/games/{$_game['game_id']}/{$_game['title_url']}">
    ...
    <li class="feeds-item">
        <div class="data-container">
            <a class="data-avatar" href="{$system['system_url']}/games/{$_game['game_id']}/{$_game['title_url']}">
                <img class="lazyload" data-src="{$_game['thumbnail']}" alt="{$_game['title']}">
            </a>
