    ...
    <div class="post-meta">
        ...
        {if !$_shared && $user->_logged_in && $_get != "posts_information"}
            <div class="float-right dropdown">
                <span class=" dropdown-toggle post_custm_option" data-toggle="dropdown" data-display="static" aria-expanded="false">
                    <i class="fas fa-ellipsis-h"></i>
                </span>
                <div class="dropdown-menu dropdown-menu-right cmn_drpdwn_style post-dropdown-menu">
                        ...
                        {if $system['packages_enabled'] && !$_post['in_group'] && !$_post['in_event']}
                            {if $_post['boosted']}
                                <div class="dropdown-item pointer js_unboost-post">
                                    <div class="action no-desc">
                                        <div class="post_images__">
                                            <img style="height:20px;width:20px;" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/Boost_Post.svg" class="blackicon">
                                            <img style="height:20px;width:20px;" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/Boost_Post-hover.svg" class="whiteicon">
                                        </div>
                            ...
                            <div class="action no-desc">
                                <div class="post_images__">
                                    <img src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/profile_iconN.svg"
                                        class="blackicon">
                                    <img src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/profile_iconN.svg.svg"
                                        class="whiteicon">
                                </div>
                    ...
                    {if $_post['photos_num'] == 1}
                        <div class="pg_1x {if $_post['photos'][0]['blur']}x-blured{/if}">
                            <a href="{$system['system_url']}/photos/{$_post['photos'][0]['photo_id']}"
                                class="js_lightbox_antier" data-id="{$_post['photos'][0]['photo_id']}"
                    ...
                    {elseif $_post['photos_num'] == 2}
                        {foreach $_post['photos'] as $photo}
                            <div class="pg_2x {if $photo['blur']}x-blured{/if}">
                                <a href="{$system['system_url']}/photos/{$photo['photo_id']}" class="js_lightbox_antier"
                            ...
                            <div class="pg_1o3">
                                <div class="pg_1o3_in {if $_post['photos'][1]['blur']}x-blured{/if}">
                                    <a href="{$system['system_url']}/photos/{$_post['photos'][1]['photo_id']}"
                                        class="js_lightbox_antier" data-id="{$_post['photos'][1]['photo_id']}"
                                ...
                                <div class="pg_1o3_in {if $_post['photos'][2]['blur']}x-blured{/if}">
                                    <a href="{$system['system_url']}/photos/{$_post['photos'][2]['photo_id']}"
                                        class="js_lightbox_antier" data-id="{$_post['photos'][2]['photo_id']}"
                            ...
                            <div class="pg_1o3">
                                ...
                                <div class="pg_1o3_in {if $_post['photos'][3]['blur']}x-blured{/if}">
                                    <a href="{$system['system_url']}/photos/{$_post['photos'][3]['photo_id']}"
                                        class="js_lightbox_antier" data-id="{$_post['photos'][3]['photo_id']}"
                    ...
                    <div class="mb5">
                        <div class="poll-option js_poll-vote" data-id="{$option['option_id']}"
                            ...
                            <div class="percentage-bg" {if $_post['poll']['votes'] > 0}
                                style="width: {($option['votes']/$_post['poll']['votes'])*100}%" {/if}></div>
                ...
                <div class="overflow-hidden">
                    <div>
                        <video class="js_fluidplayer"
                            ...
                            {if $_post['live']['video_thumbnail']}poster="{$system['system_uploads']}/{$_post['live']['video_thumbnail']}" {/if} controls preload="auto"
