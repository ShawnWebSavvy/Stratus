...
<div class="container mt20 {if $user->_logged_in}offcanvas{/if}">
    ...
    <div class="row right-side-content-ant profile-mobile-layout flex-wrap">
        <section class="profile_top_sec evnet_profile col-12">
            <!-- profile-header -->
            <div class="profile-header w-100 custom_p_header">
                    ...
                    <div class="d-flex profile_sec w-100 align-items-end">
                        <div class="profile_avatar_img">
                            ...
                            <div class="profile-avatar-wrapper">
                                <img {if !$spage[ 'page_picture_default' ]} class="js_lightbox"
                                    data-id="{$spage['page_picture_id']}" data-image="{$spage['page_picture_full']}"
                                    data-context="album" {/if} src="{$spage['page_picture']}"
                                    alt="{$spage['page_title']}"> {if $spage['i_admin']}
                                <!-- buttons -->
                        ...
                        <div class="profile_name_sec">
                            ...
                            <div class="profile-name-wrapper">
                                ...
                                <i data-toggle="tooltip" data-placement="top" title='{__("Verified Page")}'
                                    class="fa fa-check-circle fa-fw verified-badge"></i> {/if}
                            </div>
                            <!-- profile-name -->
                            <!-- profile-buttons -->
                            <div class="profile-buttons-wrapper">
                                <!-- like -->
                                {if $spage['i_like']}
                                <button type="button" class="btn  js_unlike-page unlike-button-stratus"
                                    data-id="{$spage['page_id']}">
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/local_hubN.svg"
                                        class="whiteicon">
                                    {__("Unlike")}
                                </button> {else}
                                <button type="button" class="btn js_like-page" data-id="{$spage['page_id']}">
                                    <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/local_hubN.svg"
                                        class="whiteicon">
                                    {__("Like")}
                                </button> {/if}
                                ...
                                {/if}
                                <!-- custom button -->
                                {if $spage['i_admin']} {if $system['packages_enabled']}
                                <!-- boost -->
                                {if $user->_data['can_boost_pages']} {if $spage['page_boosted']}
                                <button type="button" class="btn btn-sm btn-danger js_unboost-page"
                                    data-id="{$spage['page_id']}">
                                    <i class="fa fa-bolt mr5"></i>{__("Unboost")}
                                </button> {else}
                                <button type="button" class="btn btn-sm btn-danger js_boost-page"
                                    data-id="{$spage['page_id']}">
                                    <i class="fa fa-bolt mr5"></i>{__("Boost")}
                                </button> {/if} {else}
                                <a href="{$system['system_url']}/packages" class="btn _cmn_btn">
        ...
        <div class="col-md-12 col-xl-3 col-lg-4 aboutSectionWidth about_sec">
            <div class="profileUpdatesDesign">
                        ...
                        <ul class="about-list pages_about_list">
                            ...
                            <li>
                                <div class="about-list-item">
                                    <i class="icon-post icon_like fa-lg"></i> {$spage['page_likes']} {__("people like
                                    this")}
                                </div>
                            </li>
                            <!-- likes -->
                ...
                $spage['page_social_instagram'] || $spage['page_social_linkedin'] || $spage['page_social_vkontakte']}
                <div class="card">
                    <div class="card-header bg-transparent">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul>
                            {foreach $spage['invites'] as $_user} {include file='__feeds_user.tpl' _tpl="list"
