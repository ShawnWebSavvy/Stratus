                            ...
                            <li {if $view=="settings" }class="active" {/if}>
                                <a href="#settings" data-toggle="collapse" {if $view=="settings" }aria-expanded="true" {/if}>
                                    ...
                                    <!-- <div class="side_manu_img ">
                                        <img style="height: 20px;width: 20px;" src="{$system['system_url']}/content/themes/default/images/svg/svgImg/Cog.svg" class="blackicon">
                                    </div> -->
                                    {__("Settings")}
                                </a>
...
=======
>>>>>>> c1c00fcfa48ee3def1f8e7519466d8266259bd66
                                    </ul>
                                </div>
                            </li>
                            <!-- Settings -->
                        ...
                        <ul class="side-nav">
                            ...
                            <li {if $view=="bank" }class="active" {/if}>
                                <a href="{$system['system_url']}/{$control_panel['url']}/bank">
                                    ...
                                    <i class="fa fa-university fa-fw mr10" style="color: #4CAF50"></i>{__("Bank
                                    Receipts")}
                                </a>
                            </li>
                            <!-- Bank Receipts -->
