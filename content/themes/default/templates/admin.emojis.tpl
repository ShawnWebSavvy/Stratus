        ...
        <form class="js_ajax-forms " data-url="admin/emojis.php?do=add">
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <div class="text pt5">
                        {__("Stratus uses Twemoji Awesome and you can check")} <a class="alert-link" target="_blank" href="https://www.webpagefx.com/tools/emoji-cheat-sheet/">{__("Emoji Cheat Sheet")}</a>  {__("for the Emojis, You must replace underscores with hyphens, For example: :hatching_chick: for pattern and hatching-chickas for class")}.
                    </div>
                </div>
