    ...
    <div class="card-header with-icon">
        {if $sub_view == "find"}
            <div class="float-right">
                <a href="{$system['system_url']}/{$control_panel['url']}/pages" class="btn cmn_btn">
        ...
        {elseif $sub_view == "edit_page"}
            <div class="float-right">
                ...
                <a target="_blank" href="{$system['system_url']}/pages/{$data['page_name']}" class="btn cmn_btn">
                    <i class="fa fa-tv"></i><span class="ml5 d-none d-lg-inline-block">{__("View Page")}</span>
                </a>
                <button type="button" class="btn cmn_btn js_admin-deleter" data-handle="page_posts" data-id="{$data['page_id']}">
                    <i class="fa fa-trash-alt"></i><span class="ml5 d-none d-lg-inline-block">{__("Delete All Posts")}</span>
                </button>
            </div>
        {elseif $sub_view == "categories"}
            <div class="float-right">
                <a href="{$system['system_url']}/{$control_panel['url']}/pages/add_category" class="btn cmn_btn">
        ...
        {elseif $sub_view == "add_category" || $sub_view == "edit_category"}
            <div class="float-right">
                <a href="{$system['system_url']}/{$control_panel['url']}/pages/categories" class="btn cmn_btn">
                    <i class="fa fa-arrow-circle-left"></i><span class="ml5 d-none d-lg-inline-block">{__("Go Back")}</span>
                </a>
            </div>
        {/if}
                ...
                <div class="tab-pane active" id="page_settings">
                    <form class="js_ajax-forms " data-url="admin/pages.php?do=edit_page&edit=settings&id={$data['page_id']}">
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="title" value="{$data['page_title']}" maxlength="30">
                            </div>
                        </div>
