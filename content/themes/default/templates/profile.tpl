                        ...
                        <div class="profile-cover-wrapper">
                            {if $profile['user_cover_id']}
                                ...
                                <img class="js_position-cover-cropped {if $user->_logged_in && $profile['user_cover_lightbox']}js_lightbox{/if}"
                                    ...
                                    data-id="{$profile['user_cover_id']}" data-image="{$profile['user_cover_full']}"
                                    data-context="album" src="{$profile['user_cover']}"
                            ...
                            <div class="profile_avatar_img">
                                ...
                                <div class="profile-avatar-wrapper">
                                    ...
                                    $profile['user_picture_lightbox']}class="js_lightbox" {/if}
                                        data-id="{$profile['user_picture_id']}" data-context="album"
                                        data-image="{$profile['user_picture_full']}" {elseif
                                    ...
                                    {if $profile['user_id'] == $user->_data['user_id']}
                                        ...
                                        <div
                                            ...
                                            <i class="fa fa-crop-alt js_init-crop-picture"
                                                data-image="{$profile['user_picture_full']}"
                                                data-system-url="{$system['system_url']}" data-handle="user"
                                                data-id="{$profile['user_id']}"></i>
                                        </div>
                                        {if !$profile['user_picture_default']}
                                            <div
                                                class="profile-avatar-delete {if $profile['user_picture_default']}x-hidden{/if}">
                            ...
                            <div class="profile_name_sec">
                                ...
                                <div class="profile-name-wrapper">
                                    ...
                                    {if $profile['user_subscribed']}
                                        <a href="{$system['system_url']}/packages" class="badge  badge-warning"
                                            data-toggle="tooltip" data-placement="top"
                                            title="{$profile['package_name']} {__('Member')}">{__("PRO")}</a>
                                    {/if}
                                </div>
                                <!-- profile-buttons -->
                                            ...
                                            {if $user->_data['user_id'] != $profile['user_id']}
                                                ...
                                                {elseif $profile['he_request']}
                                                    <button type="button" class="btn btn-primary js_friend-accept"
                                                        data-uid="{$profile['user_id']}"> <span class="request_aspct">
                                                ...
                                                <!-- {if $profile['i_follow']}
                                                    ...
                                                    <button type="button" class="js_chat_start button-messages-profile"
                                                        ...
                                                        <span class="more_option">
                                                            <img class="" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/msg-icon.svg">
                                                        </span>
                                                    ...
                                                    <div class="d-inline-block dropdown button-profile-option desktop-only">
                                                        <button type="button" class=" more_icon_img" data-toggle="dropdown"
                                                            ...
                                                            <span class="more_option">
                                                                <img class="" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/more-icon.svg">
                                                            </span>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <!-- poke -->
                                                            {if $system['pokes_enabled'] && !$profile['i_poked']}
                                                                {if $profile['user_privacy_poke'] == "public" ||
                                                                ($profile['user_privacy_poke'] ==
                                                                "friends"
                                                                && $profile['we_friends'])}
                                                                <div class="dropdown-item pointer js_poke"
                                                                    data-id="{$profile['user_id']}"
                                                                    data-name="{$profile['user_firstname']} {$profile['user_lastname']}">
                                                                    <span class="more_option_img">
                                                                        <img class="" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/poke.svg">
                                                                    </span>
                                                                    {__("Poke")}
                                                                </div>
                                                            {/if}
                                                        ...
                                                        <div class="dropdown-item pointer js_report" data-handle="user"
                                                            data-id="{$profile['user_id']}">
                                                            <span class="more_option_img">
                                                                <img class="" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/Flag.svg">
                                                            </span>
                                                            {__("Report")}
                                                        </div>
                                                        <!-- report -->
                                                        <!-- block -->
                                                        <div class="dropdown-item pointer js_block-user"
                                                            data-uid="{$profile['user_id']}">
                                                            <span class="more_option_img">
                                                                <img class="" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/block_icon.svg">
                                                            </span>
                                                            {__("Block")}
                                                        </div>
                                                        <!-- block -->
                                                        ...
                                                        {if $user->_is_admin}
                                                            ...
                                                            <a class="dropdown-item"
                                                                ...
                                                                <span class="more_option_img">
                                                                    <img class="" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/Cog.svg">
                                                                </span>
                                    ...
                                    <div class="float-right">
                                        ...
                                        {elseif $profile['i_request']}
                                            <button class="btn btn-secondary  js_friend-cancel"
                                                data-uid="{$profile['user_id']}">
                                                <img class="btn_image_"
                                                    src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/tick.svg">Request
                                                Sent
                                            </button>
                                        {else}
                                            <button type="button" class="btn btn-success  js_friend-add"
                                ...
                                <div class="card-body" style="padding-top: 0px;">
                                    ...
                                    <ul class="about-list">
                                        ...
                                        {if $profile['user_work_title']}
                                            {if $profile['user_id'] == $user->_data['user_id'] ||
                                            $profile['user_privacy_work'] ==
                                            "public" || ($profile['user_privacy_work'] == "friends" &&
                                            $profile['we_friends'])}
                                            <li>
                                                <div class="about-list-item d-flex">
                                                    <div class="about_list_img">
                                                        <img class=""
                                                            src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/work_icon.svg">
                                                    </div>
                                        ...
                                        {if $profile['user_edu_major']}
                                            {if $profile['user_id'] == $user->_data['user_id'] ||
                                            $profile['user_privacy_education']
                                            ==
                                            "public" || ($profile['user_privacy_education'] == "friends" &&
                                            $profile['we_friends'])}
                                            <li>
                                                <div class="about-list-item d-flex">
                                                    <div class="about_list_img">
                                                        <img class=""
                                                            src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/univsty.svg">
                                                    </div>
                                                    <div class="about_list_text">
                                                        {__("Studied")} {$profile['user_edu_major']}
                                                        {__("at")} <span
                                                            class="text-info">{$profile['user_edu_school']}</span>
                                        ...
                                        {if $profile['user_current_city']}
                                            {if $profile['user_id'] == $user->_data['user_id'] ||
                                            $profile['user_privacy_location'] ==
                                            "public" || ($profile['user_privacy_location'] == "friends" &&
                                            $profile['we_friends'])}
                                            <li>
                                                <div class="about-list-item d-flex">
                                                    <div class="about_list_img">
                                                        <img class=""
                                                            src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/home-icb.svg">
                                                    </div>
                                                    <div class="about_list_text">
                                                        {__("Lives in")} <span
                                                            class="text-info">{$profile['user_current_city']}</span>
                                                    </div>
                                                </div>
                                            </li>
                                        {/if}
                                        ...
                                        {if $profile['user_hometown']}
                                            ...
                                            <li>
                                                <div class="about-list-item d-flex">
                                                    <div class="about_list_img">
                                                        <img class=""
                                                            src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/location_icon.svg">
                                                    </div>
                                                    <div class="about_list_text">
                                                        {__("From")} <span
                                                            class="text-info">{$profile['user_hometown']}</span>
                                                    </div>
                                                </div>
                                            </li>
                                        {/if}
                                        ...
                                        <li>
                                            <div class="about-list-item d-flex">
                                                {if $profile['user_gender'] == "male"}
                                                    <div class="about_list_img">
                                                        <img class="" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/nav_icon_friends.svg">
                                                    </div>
                                                    <div class="about_list_text">
                                                        {__("Male")}
                                                    </div>
                                        ...
                                        {if $profile['user_relationship']}
                                            ...
                                            <li>
                                                <div class="about-list-item d-flex">
                                                    <div class="about_list_img">
                                                        <img class="" src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/reletion-icon.svg">
                                                    </div>
                                                    <div class="about_list_text">
                                        ...
                                        {if $profile['user_birthdate'] != null}
                                            {if $profile['user_id'] == $user->_data['user_id'] ||
                                            $profile['user_privacy_birthdate']
                                            ==
                                            "public" || ($profile['user_privacy_birthdate'] == "friends" &&
                                            $profile['we_friends'])}
                                            <li>
                                                <div class="about-list-item d-flex">
                                                    <div class="about_list_img">
                                                        <img class=""
                                                            src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/dob_icon.svg">
                                                    </div>
                                                    <div class="about_list_text">
                                        ...
                                        <li>
                                            <div class="about-list-item d-flex">
                                                <div class="about_list_img">
                                                    <img class=" "
                                                        src="{$system['system_uploads_assets']}/content/themes/default/images/svg/svgImg/eye_icon.svg">
                                                </div>
                                                <div class="about_list_text">
                                                    {__("Followed by")}
                    ...
                    <div class="row">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active"
                                                    ...
                                                    {__("Friends")}
                                                    <span
                                                        class="badge badge-pill badge-info">{$profile['friends_count']}</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link"
                                    ...
                                    <div class="card-body pb0">
                                        ...
                                        {else}
                                            <div class="text-center text-muted mt20 no_dataimg_  __no_data_contet__ ">
                                                <img width="100%"
                                                    src="{$system['system_uploads_assets']}/content/themes/default/images/no_results16.jpg">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active"
                                                    ...
                                                    {__("Followers")}
                                                    <span
                                                        class="badge badge-pill badge-info">{$profile['followers_count']}</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link"
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active"
                                                    ...
                                                    {__("Followings")}
                                                    <span
                                                        class="badge badge-pill badge-info">{$profile['followings_count']}</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <!-- panel nav -->
                                        ...
                                        {else}
                                            <div class="__no_data_contet__ text-center">
                                                <p class="text-center text-muted __nodata-img___">
                                                    <img width="100%"
                                                        src="{$system['system_uploads_assets']}/content/themes/default/images/no_results4.png">
                                    ...
                                    <div class="card-body">
                                        ...
                                        {else}
                                            <div class="__no_data_contet__ text-center">
                                                <p class="text-center text-muted __nodata-img___">
                                                    <img width="100%"
                                                        src="{$system['system_uploads_assets']}/content/themes/default/images/no_results15.png">
                                    ...
                                    <div class="card-body">
                                        ...
                                        {else}
                                            <p class="text-center text-muted mt10 no_dataimg_">
                                                <img width="100%"
                                                    src="{$system['system_uploads_assets']}/content/themes/default/images/no_results13.png">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    {if $profile['user_id'] == $user->_data['user_id'] ||
                                    $profile['user_privacy_groups'] ==
                                    "public" || ($profile['user_privacy_groups'] == "friends" &&
                                    $profile['we_friends'])}
                                    ...
                                    {else}
                                        <div class="__no_data_contet__ text-center">
                                            <p class="text-center text-muted __nodata-img___">
                                                <img width="100%"
                                                    src="{$system['system_uploads_assets']}/content/themes/default/images/no_results17.png">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    {if $profile['user_id'] == $user->_data['user_id'] ||
                                    $profile['user_privacy_events'] ==
                                    "public" || ($profile['user_privacy_events'] == "friends" &&
                                    $profile['we_friends'])}
