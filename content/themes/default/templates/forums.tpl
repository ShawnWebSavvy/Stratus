                ...
                <div class="content-tabs custom-tabs clearfix">
                    <ul>
                        <li {if $view=="" }class="active" {/if}>
                            <a href="{$system['system_url']}/forums">{__("Home")}</a>
                        </li>
                        <li {if $view=="my-threads" }class="active" {/if}>
                            <a href="{$system['system_url']}/forums/my-threads">{__("My Threads")}</a>
                        </li>
                        <li {if $view=="my-replies" }class="active" {/if}>
                            <a href="{$system['system_url']}/forums/my-replies">{__("My Replies")}</a>
                        </li>
                        <li {if $view=="search" }class="active" {/if}>
                            <a href="{$system['system_url']}/forums/search">{__("Search")}</a>
                        </li>
                    </ul>
        ...
        <!-- content -->
            <div>
                ...
                <div class="forum-category">
                    <a
                        href="{$system['system_url']}/forums/{$forum['forum_id']}/{$forum['title_url']}">{$forum['forum_name']}</a>
                ...
                <div class="js_forum-toggle-wrapper">
                    ...
                    <div class="row forum-row">
                        ...
                        <div class="col-12 col-sm-7 column">
                            <div class="mb5">
                                <strong><a
                                        href="{$system['system_url']}/forums/{$_forum['forum_id']}/{$_forum['title_url']}">{$_forum['forum_name']}</a></strong>
                                <span class="visible-xs-inline-block">({$_forum['total_threads']}
                                    {__("Threads")} /
                                    {$_forum['total_replies']} {__("Replies")})</span>
                            </div>
                            <div class="mb5">
                            ...
                            <div>
                                <ul class="sub-forums">
                                    ...
                                    <li><a
                                            href="{$system['system_url']}/forums/{$__forum['forum_id']}/{$_forum['title_url']}">{$__forum['forum_name']}</a>{if
                                        !$__forum@last}, {/if}</li>
                                    {/foreach}
                                </ul>
                            </div>
                ...
                <div class="forum-meta-head">
                    {__("Who's online")}<span
                        class="badge badge-lg badge-light ml5">{count($online_users)|number_format:0}</span>
                </div>
                <div class="forum-meta-conent">
                    {foreach $online_users as $_user}
                    <a href="{$system['system_url']}/{$_user['user_name']}">{$_user['user_firstname']}
                        {$_user['user_lastname']}</a>{if !$_user@last}, {/if}
                    {/foreach}
                </div>
                {/if}
                <!-- online users -->
                ...
                <div class="forum-meta-conent">
                    <span class="pr10"><strong>{__("Threads")}</strong>:
                        {$insights['threads']|number_format:0}</span>
                    <span class="pr10"><strong>{__("Replies")}</strong>:
                        {$insights['replies']|number_format:0}</span>
                    <span class="pr10"><strong>{__("Members")}</strong>:
                        {$insights['users']|number_format:0}</span>
                </div>
                {/if}
                <!-- statistics -->
                {/if}
                ...
                <ol class="breadcrumb forum-breadcrumb">
                    <li class="breadcrumb-item"><a href="{$system['system_url']}/forums/"><i class="fa fa-home"></i>
                            {__("Home")}</a></li>
                    {if $forum['parents']}
                    {foreach array_reverse($forum['parents']) as $parent}
                    <li class="breadcrumb-item"><a
                            href="{$system['system_url']}/forums/{$parent['forum_id']}/{$parent['title_url']}">{$parent['forum_name']}</a>
                    </li>
                    {/foreach}
                    {/if}
                ...
                <div class="forum-title">
                    ...
                    <div class="float-right">
                        <a href="{$system['system_url']}/forums/new-thread/{$forum['forum_id']}"
                ...
                <div class="row forum-row">
                    ...
                    <div class="col-12 col-sm-7 column">
                        <div class="mb5">
                            <strong><a
                                    href="{$system['system_url']}/forums/{$_forum['forum_id']}/{$_forum['title_url']}">{$_forum['forum_name']}</a></strong>
                            <span class="visible-xs-inline-block">({$_forum['total_threads']} {__("Threads")} /
                                {$_forum['total_replies']} {__("Replies")})</span>
                        </div>
                        <div class="mb5">
                            {$_forum['forum_description']}
                ...
                <div class="row forum-row">
                    <div class="col-12 col-sm-8 column">
                        <div class="mb5">
                            <strong><a
                                    href="{$system['system_url']}/forums/thread/{$thread['thread_id']}/{$thread['title_url']}">{$thread['title']}</a></strong>
                        </div>
                        <div class="mb5">
                            {__("By")}: <a
                                href="{$system['system_url']}/{$thread['user_name']}">{$thread['user_fullname']}</a>
                ...
                <ol class="breadcrumb forum-breadcrumb">
                    ...
                    {/if}
                    <li class="breadcrumb-item"><a
                            href="{$system['system_url']}/forums/{$thread['forum']['forum_id']}/{$thread['forum']['title_url']}">{$thread['forum']['forum_name']}</a>
                    </li>
                ...
                <div class="forum-title clearfix">
                    <div class="float-right">
                        <a href="{$system['system_url']}/forums/new-reply/{$thread['thread_id']}"
                ...
                <div class="forum-thread {if $thread['replies'] > 0 && $selected_page != 1}x-hidden{/if}">
                    <div class="row">
                        <div class="col-12 col-sm-2 text-center">
                            <a href="{$system['system_url']}/{$thread['user_name']}"><img class="avatar"
                                    src="{$thread['user_picture']}"></a>
                            <h6 class="mt10">
                            ...
                            <div>
                                <small>{__("Joined")}: <span class="js_moment"
                                        data-time="{$thread['user_registered']}">{$thread['user_registered']}</span></small>
                            </div>
                        </div>
                            ...
                            <div class="time clearfix">
                                ...
                                <div class="float-right">
                                    ...
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}'
                                        href="{$system['system_url']}/forums/edit-thread/{$thread['thread_id']}"
                                        class="btn btn-sm btn-light btn-icon btn-rounded">
                                        <i class="fa fa-pencil-alt"></i>
                                    </a>
                                    <button data-toggle="tooltip" data-placement="top" title='{__("Delete")}'
                                        class="btn btn-sm btn-light btn-icon btn-rounded js_delete-forum"
                                        data-handle="thread" data-id="{$thread['thread_id']}">
                                        <i class="fa fa-trash-alt"></i>
                                    </button>
                                    {else}
                                    <button data-toggle="tooltip" data-placement="top" title='{__("Report")}'
                                        class="btn btn-sm btn-light btn-icon btn-rounded js_report"
                                        data-handle="forum_thread" data-id="{$thread['thread_id']}">
                                ...
                                <!-- buttons -->
                                <!-- time -->
                                <small><i class="far fa-clock"></i> <span class="js_moment"
                                        data-time="{$thread['time']}">{$thread['time']}</span></small>
                                <!-- time -->
                            </div>
                            <div class="text">
                                {$thread['parsed_text']}
                ...
                <div class="forum-thread" id="reply-{$reply['reply_id']}">
                    <div class="row">
                        <div class="col-12 col-sm-2 text-center">
                            <a href="{$system['system_url']}/{$reply['user_name']}"><img class="avatar"
                                    src="{$reply['user_picture']}"></a>
                            <h6 class="mt10">
                            ...
                            <div>
                                <small>{__("Joined")}: <span class="js_moment"
                                        data-time="{$reply['user_registered']}">{$reply['user_registered']}</span></small>
                            </div>
                        </div>
                        <div class="col-12 col-sm-10">
                            <div class="time clearfix">
                                <!-- buttons -->
                                <div class="float-right">
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Link")}'
                                        href="{$system['system_url']}/forums/thread/{$thread['thread_id']}/{$thread['title_url']}#reply-{$reply['reply_id']}"
                                        class="btn btn-sm btn-light btn-icon btn-rounded">
                                        <i class="fa fa-link"></i>
                                    </a>
                                    {if $reply['manage_reply']}
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}'
                                        href="{$system['system_url']}/forums/edit-reply/{$reply['reply_id']}"
                                        class="btn btn-sm btn-light btn-icon btn-rounded">
                                        <i class="fa fa-pencil-alt"></i>
                                    </a>
                                    <button data-toggle="tooltip" data-placement="top" title='{__("Delete")}'
                                        class="btn btn-sm btn-light btn-icon btn-rounded js_delete-forum"
                                        data-handle="reply" data-id="{$reply['reply_id']}">
                                        <i class="fa fa-trash-alt"></i>
                                    </button>
                                    {else}
                                    <button data-toggle="tooltip" data-placement="top" title='{__("Report")}'
                                        class="btn btn-sm btn-light btn-icon btn-rounded js_report"
                                        data-handle="forum_reply" data-id="{$reply['reply_id']}">
                                        <i class="fa fa-flag fa-fw"></i>
                                    </button>
                                    {/if}
                                </div>
                                ...
                                <!-- time -->
                                <small><i class="far fa-clock"></i> <span class="js_moment"
                                        data-time="{$reply['time']}">{$reply['time']}</span></small>
                                <!-- time -->
                            </div>
                            <div class="text">
                                {$reply['parsed_text']}
                ...
                <ol class="breadcrumb forum-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{$system['system_url']}/forums/thread/{$thread['thread_id']}/{$thread['title_url']}">{$thread['title']}</a>
                    </li>
                ...
                <ol class="breadcrumb forum-breadcrumb">
                    ...
                    {/if}
                    <li class="breadcrumb-item"><a
                            href="{$system['system_url']}/forums/{$reply['thread']['forum']['forum_id']}/{$reply['thread']['forum']['title_url']}">{$reply['thread']['forum']['forum_name']}</a>
                    </li>
                    <li class="breadcrumb-item"><a
                            href="{$system['system_url']}/forums/thread/{$reply['thread']['thread_id']}/{$reply['thread']['title_url']}">{$reply['thread']['title']}</a>
                    </li>
                ...
                <div class="forum-result">
                    <div class="head">
                        ...
                        <i class="far fa-clock mr5"></i><span class="js_moment"
                            data-time="{$thread['time']}">{$thread['time']}</span>
                    </div>
                    <div class="content">
                        <div class="mb10">
                            <div class="mb5">
                ...
                {/foreach}
                <div class="mt20">{$pager}</div>
                {else}
                <!-- no threads -->
                <div class="text-center text-muted mt20 no_dataimg_ __no_data_contet__">
                     <img width="100%"
                                src="{$system['system_url']}/content/themes/{$system['theme']}/images/no_results7.png">
                ...
                <div class="forum-result">
                    <div class="head">
                        ...
                        <i class="far fa-clock mr5"></i><span class="js_moment"
                            data-time="{$reply['time']}">{$reply['time']}</span>
                    </div>
                    <div class="content">
                        <div class="mb10">
                            <div class="mb5">
                                <strong class="title"><a
                                        href="{$system['system_url']}/forums/thread/{$reply['thread']['thread_id']}/{$reply['thread']['title_url']}">{$reply['thread']['title']}</a></strong>
                                <div class="float-right text-right">
                            ...
                            <div class="mb5">
                                {__("By")}: <a
                                    href="{$system['system_url']}/{$reply['thread']['user_name']}">{$reply['thread']['user_fullname']}</a>
                                <span class="js_moment"
                                    data-time="{$reply['thread']['time']}">{$reply['thread']['time']}</span>
                            </div>
                        </div>
                        <div class="snippet">
                ...
                <div class="forum-meta-head mt20">
                    <div class="float-right">
                        {__("Results Found")}<span class="badge badge-lg badge-light ml5">{if
                            $total}{$total}{else}0{/if}</span>
                    </div>
                ...
                {else}
                <!-- no threads -->
                <div class="text-center text-muted mt20 __no_data_contet__">
                      <img width="100%"
            ...
            <!-- right panel -->
            <div class="right-sidebar js_sticky-sidebar formsRightBar">
