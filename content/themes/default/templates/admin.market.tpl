<div class="card">
    ...
    {elseif $sub_view == "add_category"}
        ...
        <form class="js_ajax-forms admin-market-add-category-form" data-url="admin/market.php?do=add_category">
            <div class="card-body">
    ...
    {elseif $sub_view == "edit_category"}
        ...
        <form class="js_ajax-forms admin-market-edit-category-form" data-url="admin/market.php?do=edit_category&id={$data['category_id']}">
            <div class="card-body">
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        {__("Name")}
