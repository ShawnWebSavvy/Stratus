            ...
            <div class="row">
                ...
                <div class="home-page-middel-block">
                    ...
                    <div class="card story-card">
                        {if $has_story}
                            <button data-toggle="tooltip" data-placement="top" title='{__("Delete Your Story")}' class="btn btn-sm btn-icon btn-rounded js_story-deleter">
                                <img src="{$system['system_url']}/content/themes/default/images/svg/svgImg/modelCross.svg" class="blackicon">
                            </button>
                        {/if}
