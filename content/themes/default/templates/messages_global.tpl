    ...
    <div class="row right-side-content-ant mobileMessageWrap users">
        ...
        <div class="col-md-4 col-xl-3 leftSideChatBar">
            <div class="card">
                <div class="card-header" style="margin-bottom: 0;">
                    ...
                    <a class="js_chat-new" href="{$system['system_url']}/globalMessages/new">
                ...
                <div class="card-body plr0 js_live-messages-alt">
                        ...
                        <ul class="nav nav-tabs messageTabs">
                          <li class="active dmDiv"><a class="active" data-toggle="tab" href="#directMessages">Direct Messages</a></li>
                        ...
                        <div class="tab-content">
                          <div id="directMessages" class="tab-pane fade in active show">
                                    ...
                                    {if $userGlobal->_data['conversations']}
                                        <ul class="forsingle">
                          ...
                          <div id="menu1" class="tab-pane fade">
                                ...
                                {if $userGlobal->_data['conversations']}
                                    <ul class="forgroup">
                                    {foreach $userGlobal->_data['conversations'] as $_conversations}
        ...
        <div class="col-md-8 col-xl-9 offcanvas-mainbar chatBoxBlock js_conversation-container">
            ...
            <div class="card panel-messages fresh">
                ...
                <div class="card-body">
                    <div class="chat-conversations js_scroller" data-slimScroll-height="calc(100vh - 275px)"></div>
                    <div class="chat-to clearfix js_autocomplete-tags">
                        <div class="to">{__("To")}:</div>
                        <ul class="tags">
                            {if $recipient}
                            <li data-uid="{$recipient['user_id']}">{$recipient['user_fullname']}<button type="button"
                                    class="close js_tag-remove" title="{__(" Remove")}"><span>×</span></button></li>
                            {/if}
                        </ul>
            ...
            <div class="card card-messages" style="padding-top: 60px;">
                <div class="card-body text-center text-muted" style="min-height: 510px;">
                    <div class="noMessageChanges">
                        ...
                        <a class="btn btn-sm btn-primary js_chat-new" href="{$system['system_url']}/globalMessages/new">{__("New Message")}</a>
                    </div>
                </div>
            </div>
            {/if}
