<div class="card">
    ...
    {elseif $sub_view == "add_category"}
        ...
        <form class="js_ajax-forms event-add-category-form" data-url="admin/events.php?do=add_category">
            <div class="card-body">
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        {__("Name")}
    ...
    {elseif $sub_view == "edit_category"}
        ...
        <form class="js_ajax-forms event-edit-category-form" data-url="admin/events.php?do=edit_category&id={$data['category_id']}">
            <div class="card-body">
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        {__("Name")}
