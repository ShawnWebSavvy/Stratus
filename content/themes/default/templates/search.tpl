            ...
            <div class="form-group">
              <div class="input-group searchPageBar">
                ...
                <div class="input-group-append">
                  <button type="submit" name="submit" class="btn btn-success btn-antier-green">
                    <i class="fas fa-search mr10"></i>{__("Search")}
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-12">
            <div class="row custom-tabs">
              ...
              <ul class="nav nav-tabs mb10">
                ...
                <li class="nav-item">
                  <a class="nav-link rounded-pill" href="#articles" data-toggle="tab">{__("Articles")}</a>
                </li>
                {/if}
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link rounded-pill" href="#pages" data-toggle="tab">{__("Pages")}</a>
                </li>
                {/if} {if $system['groups_enabled']}
                <li class="nav-item">
                  <a class="nav-link rounded-pill" href="#groups" data-toggle="tab">{__("Groups")}</a>
                </li>
                {/if} {if $system['events_enabled']}
                <li class="nav-item">
                  <a class="nav-link rounded-pill" href="#events" data-toggle="tab">{__("Events")}</a>
                </li>
                {/if}
              </ul>
              <!-- panel nav -->
              ...
              <div class="tab-content" style="width: 100%">
                <!-- posts -->
                <div class="tab-pane{if !$results['users'] || count($results['users']) < 1} active{/if}" id="posts">
                  {if $results['posts'] && count($results['posts']) > 0}
                  <ul>
                    {foreach $results['posts'] as $post} {include
                    file='__feeds_post.tpl'} {/foreach}
                  </ul>
                  {else}
                ...
                <div class="tab-pane" id="articles">
                  ...
                  <ul>
                    {foreach $results['articles'] as $post} {include
                    file='__feeds_post.tpl'} {/foreach}
                  </ul>
                  {else}
                ...
                <!-- users -->
                <div class="tab-pane {if $results['users'] && count($results['users']) > 0}active{/if}" id="users">
                  {if $results['users'] && count($results['users']) > 0}
                  <ul>
                    {foreach $results['users'] as $_user} {include
                    file='__feeds_user.tpl' _tpl="list"
                ...
                <div class="tab-pane" id="pages">
                  ...
                  <ul>
                    {foreach $results['pages'] as $_page} {include
                    file='__feeds_page.tpl' _tpl="list"} {/foreach}
                  </ul>
                  {else}
                  <div class="text-center text-muted mtb10 no_results_Wrap">
                    <img width="100%"
                ...
                <div class="tab-pane" id="groups">
                  ...
                  <ul>
                    {foreach $results['groups'] as $_group} {include
                    file='__feeds_group.tpl' _tpl="list"} {/foreach}
                  </ul>
                  {else}
                  <div class="text-center text-muted mtb10 no_results_Wrap">
                    <img width="100%"
                ...
                <div class="tab-pane" id="events">
                  ...
                  <ul>
                    {foreach $results['events'] as $_event} {include
                    file='__feeds_event.tpl' _tpl="list"} {/foreach}
                  </ul>
                  {else}
                  <div class="text-center text-muted mtb10 no_results_Wrap">
                    <img width="100%"
