...
/* Smarty version 3.1.34-dev-7, created on 2021-01-05 12:36:04
  from '/opt/lampp/htdocs/sngine/content/themes/default/templates/global-profile/global-profile__feeds_comment.form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ff45d34b149f3_89372897',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ffa2dbc91317f2c140184e4d5e7bda0fea8a5028' => 
    array (
      0 => '/opt/lampp/htdocs/sngine/content/themes/default/templates/global-profile/global-profile__feeds_comment.form.tpl',
      1 => 1609222533,
      2 => 'file',
    ),
  ),
...
function content_5ff45d34b149f3_89372897 (Smarty_Internal_Template $_smarty_tpl) {
?><div
  class="comment js_comment-form <?php if ($_smarty_tpl->tpl_vars['post']->value['comments_disabled']) {?>x-hidden<?php }?>"
...
"
      style="
        background-image: url(<?php echo $_smarty_tpl->tpl_vars['userGlobal']->value->_data['user_picture'];?>
);
      "
    >
    </a>
  ...
  <div class="comment-data">
    <div class="x-form comment-form commentFormChanges">
      <textarea maxlength="260" dir="auto" class="js_autosize js_mention js_post-comment" rows="1" placeholder='<?php echo __("What is your Stratus? @mention #hashtag");?>
'></textarea>
      <ul class="x-form-tools clearfix">
        ...
        <?php }?> <?php if ($_smarty_tpl->tpl_vars['system']->value['voice_notes_comments_enabled']) {?>
        ...
        <li class="x-form-tools-post js_post-comment comment_postBtn">
...
?> <?php echo __("Voice note recorded successfully");?>
    ...
    <!-- <button
      type="button"
      class="btn btn-sm btn-success ml5 btn-antier-green btn-publisher comment_postBtn"
    >
      <?php echo __("Post");?>
...
<div
  class="pb10 text-center js_comment-disabled-msg <?php if (!$_smarty_tpl->tpl_vars['post']->value['comments_disabled']) {?>x-hidden<?php }?>"
>
