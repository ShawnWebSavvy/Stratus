<?php
/* Smarty version 3.1.34-dev-7, created on 2021-01-07 10:04:00
  from '/opt/lampp/htdocs/sngine/content/themes/default/templates/_posts.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ff6dc905f0190_54559116',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bf41c98a0848c7af98406dd7f011bfea185b847e' => 
    array (
      0 => '/opt/lampp/htdocs/sngine/content/themes/default/templates/_posts.tpl',
      1 => 1610013793,
      2 => 'file',
    ),
  ),
...
function content_5ff6dc905f0190_54559116 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- posts-filter -->
...
' data-value="live"><i
						class="fa fa-signal fa-fw mr10"></i><?php echo __("Live");?>
</div>
				<?php }?>
...
/content/themes/default/images/svg/svgImg/add_video_icon.svg">
				...
				<div class="dropdown-item pointer" data-title='<?php echo __("Audio");?>
' data-value="audio">
					<div class="imgHover">
...
<div class="js_posts_stream" id="posts_all" data-get="<?php echo $_smarty_tpl->tpl_vars['_get']->value;?>
...
" <?php }?>>
	...
	<ul class="feeds_post_ul" id="<?php if ($_smarty_tpl->tpl_vars['subactive_page']->value) {?>profile_feeds_post_ul<?php } else { ?>landing_feeds_post_ul<?php }?>">
		<!-- posts -->
		<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<!-- see-more -->
	<div class="alert alert-post see-more mb20 js_see-more <?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>js_see-more-infinite<?php }?>"
		data-get="<?php echo $_smarty_tpl->tpl_vars['_get']->value;?>
" data-filter="<?php if ($_smarty_tpl->tpl_vars['_filter']->value) {
echo $_smarty_tpl->tpl_vars['_filter']->value;
} else { ?>all<?php }?>" <?php if ($_smarty_tpl->tpl_vars['_id']->value) {?>data-id="<?php echo $_smarty_tpl->tpl_vars['_id']->value;?>
" <?php }?>>
	...
	<!-- see-more -->
	<?php } else { ?>
	<div class="js_posts_stream no-data-main no_data_img_ __no_data_contet__" data-get="<?php echo $_smarty_tpl->tpl_vars['_get']->value;?>
"
		data-filter="<?php if ($_smarty_tpl->tpl_vars['_filter']->value) {
echo $_smarty_tpl->tpl_vars['_filter']->value;
} else { ?>all<?php }?>" <?php if ($_smarty_tpl->tpl_vars['_id']->value) {?>data-id="<?php echo $_smarty_tpl->tpl_vars['_id']->value;?>
