<?php
/* Smarty version 3.1.34-dev-7, created on 2021-01-05 12:39:01
  from '/opt/lampp/htdocs/sngine/content/themes/default/templates/global-profile/__feeds_comment.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ff45de5c2a858_81106365',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8a07cb29d1e1559e0f574fe6076e2aa438d131a2' => 
    array (
      0 => '/opt/lampp/htdocs/sngine/content/themes/default/templates/global-profile/__feeds_comment.tpl',
      1 => 1609222533,
      2 => 'file',
    ),
  ),
...
function content_5ff45de5c2a858_81106365 (Smarty_Internal_Template $_smarty_tpl) {
?><li>
...
?>
                ...
                <div class="comment-btn">
                    <button type="button" class="close js_report" data-handle="comment"
                        data-id="<?php echo $_smarty_tpl->tpl_vars['_comment']->value['comment_id'];?>
" data-toggle="tooltip" data-placement="top"
                        title='<?php echo __("Report");?>
'>
...
'>
                ...
                <div class="comment-btn dropdown">
                    <button type="button" class="close" data-toggle="dropdown" data-display="static"
                        data-tooltip="tooltip" data-placement="top" title='<?php echo __("Edit or Delete");?>
'>
            ...
            <ul class="comment-actions clearfix">
                <!-- reactions -->
                <li>
                    <div class="pointer unselectable sss reactions-wrapper <?php if ($_smarty_tpl->tpl_vars['_comment']->value['i_react']) {?>js_unreact-comment<?php }?>"
                        data-reaction="<?php echo $_smarty_tpl->tpl_vars['_comment']->value['i_reaction'];?>
">
                        <!-- reaction-btn -->
...
?>
                            ...
                            <span
                                class="reaction-btn-name text-link <?php echo $_smarty_tpl->tpl_vars['_comment']->value['i_reaction_details']['color'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <!-- comment -->
                <li>
                    <span class="text-link js_reply <?php if ($_smarty_tpl->tpl_vars['_comment']->value['comments_disabled']) {?>x-hidden<?php }?>"
                        data-username="<?php if ($_smarty_tpl->tpl_vars['user']->value->_data['user_name'] != $_smarty_tpl->tpl_vars['_comment']->value['author_user_name']) {
                ...
                <div class="x-hidden js_reply-form">
                    <div class="x-form comment-form commentFormChanges">
                        <textarea maxlength="260" dir="auto" class="js_autosize js_mention js_post-reply" rows="1"
                            placeholder='<?php echo __("Write a Reply");?>
'></textarea>
