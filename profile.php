...
try {
	...
	$TIMES["BEFORE IF LOGIN"] = microtime(true) - $LAST_TIME; $LAST_TIME = microtime(true);
...
//			$smarty->assign('posts', $posts);
	...
	$TIMES["BEFORE NOTIFICATIONS"] = microtime(true) - $LAST_TIME; $LAST_TIME = microtime(true);
	...
	$TIMES["BEFORE TRENDING"] = microtime(true) - $LAST_TIME; $LAST_TIME = microtime(true);
 ...
 */
	...
	$TIMES["BEFORE GET GROUPS"] = microtime(true) - $LAST_TIME; $LAST_TIME = microtime(true);
	...
	$TIMES["BEFORE GET EVENTS"] = microtime(true) - $LAST_TIME; $LAST_TIME = microtime(true);
	...
	$TIMES["BEFORE ANNOUNCEMENTS"] = microtime(true) - $LAST_TIME; $LAST_TIME = microtime(true);
	// get announcements
	$announcements = $user->announcements();
	// assign variables 
	$smarty->assign('announcements', $announcements);

	$TIMES["BEFORE ADS CAMPAIGNS"] = microtime(true) - $LAST_TIME; $LAST_TIME = microtime(true);
	// get ads campaigns
	...
	// get widgets
	$TIMES["BEFORE WIDGETS"] = microtime(true) - $LAST_TIME; $LAST_TIME = microtime(true);
